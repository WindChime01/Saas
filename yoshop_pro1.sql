...
--
-- Host: localhost
-- Generation Time: 2022-09-26 09:06:00
-- 服务器版本： 5.6.50-log
-- PHP Version: 5.6.40
...
CREATE TABLE IF NOT EXISTS `yoshop_admin_user` (
...
CREATE TABLE IF NOT EXISTS `yoshop_article` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='文章记录表';

--
-- 转存表中的数据 `yoshop_article`
--

INSERT INTO `yoshop_article` (`article_id`, `article_title`, `show_type`, `category_id`, `image_id`, `article_content`, `article_sort`, `article_status`, `virtual_views`, `actual_views`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '纽西卡汽车小镇线上商城上线啦', 10, 10001, 10093, '&lt;p&gt;测试测试&lt;/p&gt;', 100, 1, 0, 12, 0, 10005, 1662543832, 1663127588),
(10002, '纽西卡汽车小镇线上商城上线啦', 10, 10001, 10094, '&lt;p&gt;测试&lt;/p&gt;', 100, 1, 0, 9, 0, 10005, 1663132887, 1663132887);
...
CREATE TABLE IF NOT EXISTS `yoshop_article_category` (
...
--
-- 转存表中的数据 `yoshop_article_category`
--

INSERT INTO `yoshop_article_category` (`category_id`, `name`, `sort`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '测试', 100, 10005, 1662543810, 1662543810);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_bargain_active`
--

CREATE TABLE IF NOT EXISTS `yoshop_bargain_active` (
  `active_id` int(11) unsigned NOT NULL COMMENT '砍价活动id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10005 DEFAULT CHARSET=utf8 COMMENT='砍价活动表';

--
-- 转存表中的数据 `yoshop_bargain_active`
--

INSERT INTO `yoshop_bargain_active` (`active_id`, `goods_id`, `start_time`, `end_time`, `expiryt_time`, `floor_price`, `peoples`, `is_self_cut`, `is_floor_buy`, `share_title`, `prompt_words`, `actual_sales`, `initial_sales`, `sort`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10004, 1645003784, 1645545600, 24, '5.00', 5, 1, 0, '麻烦帮我砍一刀！我真的很想要了，爱你哟！(๑′ᴗ‵๑)', '&quot;朋友一生一起走，帮砍一刀有没有&quot;', 0, 1, 100, 1, 0, 10001, 1645003840, 1645003840),
(10002, 10006, 1662603206, 1662652800, 24, '30.00', 3, 1, 0, '麻烦帮我砍一刀！我真的很想要了，爱你哟！(๑′ᴗ‵๑)', '&quot;朋友一生一起走，帮砍一刀有没有&quot;', 0, 20, 100, 1, 0, 10005, 1662603290, 1662603290),
(10003, 10008, 1662603206, 1662652800, 24, '50.00', 10, 1, 0, '麻烦帮我砍一刀！我真的很想要了，爱你哟！(๑′ᴗ‵๑)', '&quot;朋友一生一起走，帮砍一刀有没有&quot;', 0, 30, 100, 1, 0, 10005, 1662603423, 1662603423),
(10004, 10010, 1663229755, 1663344000, 24, '80.00', 15, 1, 0, '麻烦帮我砍一刀！我真的很想要了，爱你哟！(๑′ᴗ‵๑)', '&quot;朋友一生一起走，帮砍一刀有没有&quot;', 0, 12, 100, 1, 0, 10005, 1663229797, 1663229797);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_bargain_setting`
--

CREATE TABLE IF NOT EXISTS `yoshop_bargain_setting` (
...
--
-- 转存表中的数据 `yoshop_bargain_setting`
--

INSERT INTO `yoshop_bargain_setting` (`key`, `describe`, `values`, `wxapp_id`, `update_time`) VALUES
('basic', '基础设置', '{"is_dealer":"0","bargain_rules":"\\u6d3b\\u52a8\\u671f\\u95f4\\uff0c\\u7528\\u6237\\u53ef\\u4ee5\\u5728\\u780d\\u4ef7\\u6d3b\\u52a8\\u9875\\u9009\\u62e9\\u6d3b\\u52a8\\u5546\\u54c1\\u53d1\\u8d77\\u780d\\u4ef7\\uff0c\\u53ef\\u901a\\u8fc7\\u5fae\\u4fe1\\u5206\\u4eab\\u780d\\u4ef7\\u5546\\u54c1\\u6d3b\\u52a8\\u9875\\u9762\\u7ed9\\u597d\\u53cb\\uff0c\\u5e76\\u901a\\u8fc7\\u597d\\u53cb\\u52a9\\u529b\\u780d\\u4ef7\\uff0c\\u5c06\\u5546\\u54c1\\u780d\\u81f3\\u4e00\\u5b9a\\u91d1\\u989d\\u3002\\n\\n\\u6bcf\\u6b21\\u780d\\u4ef7\\u91d1\\u989d\\u968f\\u673a\\uff0c\\u53ef\\u780d\\u51fa\\u6700\\u9ad8\\u5546\\u54c1\\u65e5\\u5e38\\u4ef7\\u5185\\u7684\\u968f\\u673a\\u91d1\\u989d\\uff0c\\u53c2\\u4e0e\\u597d\\u53cb\\u8d8a\\u591a\\u8d8a\\u5bb9\\u6613\\u6210\\u529f\\u3002\\n\\n\\u4ee5\\u6700\\u7ec8\\u780d\\u4ef7\\u540e\\u7684\\u4f18\\u60e0\\u4ef7\\u683c\\u8d2d\\u4e70\\u8be5\\u5546\\u54c1\\uff0c\\u4e14\\u7528\\u6237\\u987b\\u5728\\u6d3b\\u52a8\\u65f6\\u95f4\\u7ed3\\u675f\\u4e4b\\u524d\\u8fdb\\u884c\\u652f\\u4ed8\\u8d2d\\u4e70\\uff0c\\u5426\\u5219\\u780d\\u4ef7\\u5546\\u54c1\\u4ef7\\u683c\\u5c06\\u8fc7\\u671f\\u5931\\u6548\\u3002\\n\\n\\u5546\\u54c1\\u5e93\\u5b58\\u6709\\u9650\\uff0c\\u4ee5\\u524d\\u53f0\\u5c55\\u793a\\u7684\\u5e93\\u5b58\\u6570\\u91cf\\u4e3a\\u51c6\\uff0c\\u5148\\u5230\\u5148\\u5f97\\u3002"}', 10001, 1661358939);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_bargain_task`
--

CREATE TABLE IF NOT EXISTS `yoshop_bargain_task` (
  `task_id` int(11) unsigned NOT NULL COMMENT '砍价任务id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10005 DEFAULT CHARSET=utf8 COMMENT='砍价任务表';

--
-- 转存表中的数据 `yoshop_bargain_task`
--

INSERT INTO `yoshop_bargain_task` (`task_id`, `active_id`, `user_id`, `goods_id`, `spec_sku_id`, `goods_price`, `floor_price`, `peoples`, `cut_people`, `section`, `cut_money`, `actual_price`, `is_floor`, `end_time`, `is_buy`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 10001, 10004, '0', '11.00', '5.00', 5, 1, '["1.27","1.76","1.09","0.86","1.02"]', '1.27', '9.73', 0, 1645090267, 0, 0, 0, 10001, 1645003867, 1645090432),
(10002, 10003, 10043, 10008, '0', '60.00', '50.00', 10, 1, '["0.96","0.71","0.94","0.80","0.47","0.70","0.71","1.27","1.94","1.50"]', '0.96', '59.04', 0, 1662691112, 0, 0, 0, 10005, 1662604712, 1662705988),
(10003, 10002, 10043, 10006, '0', '45.00', '30.00', 3, 1, '["4.15","2.65","8.20"]', '4.15', '40.85', 0, 1662703520, 0, 0, 0, 10005, 1662617120, 1662705988),
(10004, 10004, 10046, 10010, '0', '98.00', '80.00', 15, 1, '["1.10","0.61","0.85","1.63","0.61","1.10","1.38","1.37","0.95","1.97","1.28","0.68","1.23","2.23","1.01"]', '1.10', '96.90', 0, 1663324423, 0, 1, 0, 10005, 1663238023, 1663238023);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_bargain_task_help`
--

CREATE TABLE IF NOT EXISTS `yoshop_bargain_task_help` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10005 DEFAULT CHARSET=utf8 COMMENT='砍价任务助力记录表';

--
-- 转存表中的数据 `yoshop_bargain_task_help`
--

INSERT INTO `yoshop_bargain_task_help` (`help_id`, `active_id`, `task_id`, `user_id`, `is_creater`, `cut_money`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 10001, 10001, 1, '1.27', 10001, 1645003867),
(10002, 10003, 10002, 10043, 1, '0.96', 10005, 1662604712),
(10003, 10002, 10003, 10043, 1, '4.15', 10005, 1662617120),
(10004, 10004, 10004, 10046, 1, '1.10', 10005, 1663238023);
...
CREATE TABLE IF NOT EXISTS `yoshop_category` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10017 DEFAULT CHARSET=utf8 COMMENT='商品分类表';
...
(10001, '香水', 0, 10047, 100, 10001, 1644976421, 1645169064),
(10002, '香水', 10001, 10033, 100, 10001, 1644978391, 1645169217),
(10003, '妆前乳', 0, 10051, 100, 10001, 1645169096, 1645169096),
(10004, '粉底', 0, 0, 100, 10001, 1645169169, 1645169169),
(10005, '口红', 0, 0, 100, 10001, 1645169187, 1645169187),
(10006, '香水', 10001, 10034, 100, 10001, 1645169239, 1645169239),
(10007, '香水', 10001, 10038, 100, 10001, 1645169271, 1645169271),
(10008, '香水', 10001, 10043, 100, 10001, 1645169294, 1645169294),
(10009, '妆前乳', 10003, 10049, 100, 10001, 1645169308, 1645169385),
(10010, '妆前乳', 10003, 10051, 100, 10001, 1645169425, 1645169425),
(10011, '粉底', 10004, 10049, 100, 10001, 1645169471, 1645169471),
(10012, '睫毛膏', 0, 0, 100, 10001, 1645169533, 1645169533),
(10013, '生活用品', 0, 10111, 3, 10005, 1662541732, 1663565156),
(10014, '科学实验', 0, 10110, 4, 10005, 1662544504, 1663565211),
(10015, '益智玩具', 0, 10108, 2, 10005, 1663053321, 1663565133),
(10016, '会员专区', 0, 10112, 1, 10005, 1663565177, 1663565177);
...
CREATE TABLE IF NOT EXISTS `yoshop_comment` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='订单评价记录表';

--
-- 转存表中的数据 `yoshop_comment`
--

INSERT INTO `yoshop_comment` (`comment_id`, `score`, `content`, `is_picture`, `sort`, `status`, `user_id`, `order_id`, `goods_id`, `order_goods_id`, `wxapp_id`, `is_delete`, `create_time`, `update_time`) VALUES
(10001, 10, '测试评价', 0, 100, 1, 10043, 10014, 10005, 10015, 10005, 0, 1662604460, 1662604460);
...
CREATE TABLE IF NOT EXISTS `yoshop_comment_image` (
...
CREATE TABLE IF NOT EXISTS `yoshop_coupon` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10005 DEFAULT CHARSET=utf8 COMMENT='优惠券记录表';
...
(10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 0, 0, 10, 10, 5, 100, 0, 10001, 1644980214, 1644980214),
(10002, '满10减9', 20, 10, '9.00', 0, '10.00', 10, 30, 0, 0, 10, -1, 3, 100, 0, 10001, 1646723893, 1646723893),
(10003, '优惠券测试二', 10, 10, '20.00', 0, '123.00', 10, 3, 0, 0, 10, -1, 1, 100, 0, 10005, 1662543880, 1663136608),
(10004, '优惠券测试三', 10, 10, '20.00', 0, '200.00', 10, 3, 0, 0, 10, -1, 1, 100, 0, 10005, 1662602887, 1663136622);
...
CREATE TABLE IF NOT EXISTS `yoshop_coupon_goods` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_apply` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10004 DEFAULT CHARSET=utf8 COMMENT='分销商申请记录表';
...
(10001, 10002, '钟', '15019998211', 0, 10, 1650267184, 20, 1650267191, '', 10001, 1650267184, 1650267191),
(10002, 10038, '11', '13000000000', 0, 10, 1659339099, 20, 1659339158, '', 10001, 1659339099, 1659339158),
(10003, 10043, '分销测试', '13888888888', 0, 10, 1662619481, 20, 1662619571, '', 10005, 1662619481, 1662619571);
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_capital` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_order` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_referee` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_setting` (
  `key` varchar(30) NOT NULL DEFAULT '' COMMENT '设置项标示',
  `describe` varchar(255) NOT NULL DEFAULT '' COMMENT '设置项描述',
  `values` mediumtext NOT NULL COMMENT '设置内容(json格式)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
('background', '页面背景图', '{"__":"","index":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png","apply":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png","withdraw_apply":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png"}', 10001, 1650267139),
('background', '页面背景图', '{"__":"","index":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png","apply":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png","withdraw_apply":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/api\\/dealer-bg.png"}', 10005, 1662619163),
('basic', '基础设置', '{"is_open":"1","level":"2","self_buy":"1"}', 10001, 1650267139),
('basic', '基础设置', '{"is_open":"1","level":"3","self_buy":"0"}', 10005, 1662619163),
('commission', '佣金设置', '{"first_money":"30","second_money":"20","third_money":"10"}', 10001, 1650267139),
('commission', '佣金设置', '{"first_money":"10","second_money":"8","third_money":"5"}', 10005, 1662621081),
('condition', '分销商条件', '{"become":"10","become__buy_goods":"1","become__buy_goods_ids":["10004"],"downline":"10"}', 10001, 1650267139),
('condition', '分销商条件', '{"become":"10","become__buy_goods":"0","downline":"10"}', 10005, 1662619163),
('license', '申请协议', '{"license":""}', 10001, 1650267139),
('license', '申请协议', '{"license":""}', 10005, 1662619163),
('qrcode', '分销海报', '{"backdrop":{"src":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/dealer\\/backdrop.png"},"nickName":{"fontSize":"14","color":"#000000","left":"150","top":"99"},"avatar":{"width":"70","style":"circle","left":"150","top":"18"},"qrcode":{"width":"100","style":"circle","left":"136","top":"128"}}', 10005, 1662619041),
('settlement', '结算', '{"pay_type":["10"],"min_money":"10.00","settle_days":"1"}', 10001, 1650267139),
('settlement', '结算', '{"pay_type":["10"],"min_money":"10.00","settle_days":"10"}', 10005, 1662619163),
('words', '自定义文字', '{"index":{"title":{"value":"\\u5206\\u9500\\u4e2d\\u5fc3"},"words":{"not_dealer":{"value":"\\u60a8\\u8fd8\\u4e0d\\u662f\\u5206\\u9500\\u5546\\uff0c\\u8bf7\\u5148\\u63d0\\u4ea4\\u7533\\u8bf7"},"apply_now":{"value":"\\u7acb\\u5373\\u52a0\\u5165"},"referee":{"value":"\\u63a8\\u8350\\u4eba"},"money":{"value":"\\u53ef\\u63d0\\u73b0"},"freeze_money":{"value":"\\u5f85\\u63d0\\u73b0"},"total_money":{"value":"\\u5df2\\u63d0\\u73b0\\u91d1\\u989d"},"withdraw":{"value":"\\u53bb\\u63d0\\u73b0"}}},"apply":{"title":{"value":"\\u7533\\u8bf7\\u6210\\u4e3a\\u5206\\u9500\\u5546"},"words":{"title":{"value":"\\u8bf7\\u586b\\u5199\\u7533\\u8bf7\\u4fe1\\u606f"},"license":{"value":"\\u5206\\u9500\\u5546\\u7533\\u8bf7\\u534f\\u8bae"},"submit":{"value":"\\u7533\\u8bf7\\u6210\\u4e3a\\u7ecf\\u9500\\u5546"},"wait_audit":{"value":"\\u60a8\\u7684\\u7533\\u8bf7\\u5df2\\u53d7\\u7406\\uff0c\\u6b63\\u5728\\u8fdb\\u884c\\u4fe1\\u606f\\u6838\\u9a8c\\uff0c\\u8bf7\\u8010\\u5fc3\\u7b49\\u5f85\\u3002"},"goto_mall":{"value":"\\u53bb\\u5546\\u57ce\\u901b\\u901b"}}},"order":{"title":{"value":"\\u5206\\u9500\\u8ba2\\u5355"},"words":{"all":{"value":"\\u5168\\u90e8"},"unsettled":{"value":"\\u672a\\u7ed3\\u7b97"},"settled":{"value":"\\u5df2\\u7ed3\\u7b97"}}},"team":{"title":{"value":"\\u6211\\u7684\\u56e2\\u961f"},"words":{"total_team":{"value":"\\u56e2\\u961f\\u603b\\u4eba\\u6570"},"first":{"value":"\\u4e00\\u7ea7\\u56e2\\u961f"},"second":{"value":"\\u4e8c\\u7ea7\\u56e2\\u961f"},"third":{"value":"\\u4e09\\u7ea7\\u56e2\\u961f"}}},"withdraw_list":{"title":{"value":"\\u63d0\\u73b0\\u660e\\u7ec6"},"words":{"all":{"value":"\\u5168\\u90e8"},"apply_10":{"value":"\\u5ba1\\u6838\\u4e2d"},"apply_20":{"value":"\\u5ba1\\u6838\\u901a\\u8fc7"},"apply_40":{"value":"\\u5df2\\u6253\\u6b3e"},"apply_30":{"value":"\\u9a73\\u56de"}}},"withdraw_apply":{"title":{"value":"\\u7533\\u8bf7\\u63d0\\u73b0"},"words":{"capital":{"value":"\\u53ef\\u63d0\\u73b0\\u4f63\\u91d1"},"money":{"value":"\\u63d0\\u73b0\\u91d1\\u989d"},"money_placeholder":{"value":"\\u8bf7\\u8f93\\u5165\\u8981\\u63d0\\u53d6\\u7684\\u91d1\\u989d"},"min_money":{"value":"\\u6700\\u4f4e\\u63d0\\u73b0\\u4f63\\u91d1"},"submit":{"value":"\\u63d0\\u4ea4\\u7533\\u8bf7"}}},"qrcode":{"title":{"value":"\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u7801"}}}', 10001, 1650267139),
('words', '自定义文字', '{"index":{"title":{"value":"\\u5206\\u9500\\u4e2d\\u5fc3"},"words":{"not_dealer":{"value":"\\u60a8\\u8fd8\\u4e0d\\u662f\\u5206\\u9500\\u5546\\uff0c\\u8bf7\\u5148\\u63d0\\u4ea4\\u7533\\u8bf7"},"apply_now":{"value":"\\u7acb\\u5373\\u52a0\\u5165"},"referee":{"value":"\\u63a8\\u8350\\u4eba"},"money":{"value":"\\u53ef\\u63d0\\u73b0"},"freeze_money":{"value":"\\u5f85\\u63d0\\u73b0"},"total_money":{"value":"\\u5df2\\u63d0\\u73b0\\u91d1\\u989d"},"withdraw":{"value":"\\u53bb\\u63d0\\u73b0"}}},"apply":{"title":{"value":"\\u7533\\u8bf7\\u6210\\u4e3a\\u5206\\u9500\\u5546"},"words":{"title":{"value":"\\u8bf7\\u586b\\u5199\\u7533\\u8bf7\\u4fe1\\u606f"},"license":{"value":"\\u5206\\u9500\\u5546\\u7533\\u8bf7\\u534f\\u8bae"},"submit":{"value":"\\u7533\\u8bf7\\u6210\\u4e3a\\u7ecf\\u9500\\u5546"},"wait_audit":{"value":"\\u60a8\\u7684\\u7533\\u8bf7\\u5df2\\u53d7\\u7406\\uff0c\\u6b63\\u5728\\u8fdb\\u884c\\u4fe1\\u606f\\u6838\\u9a8c\\uff0c\\u8bf7\\u8010\\u5fc3\\u7b49\\u5f85\\u3002"},"goto_mall":{"value":"\\u53bb\\u5546\\u57ce\\u901b\\u901b"}}},"order":{"title":{"value":"\\u5206\\u9500\\u8ba2\\u5355"},"words":{"all":{"value":"\\u5168\\u90e8"},"unsettled":{"value":"\\u672a\\u7ed3\\u7b97"},"settled":{"value":"\\u5df2\\u7ed3\\u7b97"}}},"team":{"title":{"value":"\\u6211\\u7684\\u56e2\\u961f"},"words":{"total_team":{"value":"\\u56e2\\u961f\\u603b\\u4eba\\u6570"},"first":{"value":"\\u4e00\\u7ea7\\u56e2\\u961f"},"second":{"value":"\\u4e8c\\u7ea7\\u56e2\\u961f"},"third":{"value":"\\u4e09\\u7ea7\\u56e2\\u961f"}}},"withdraw_list":{"title":{"value":"\\u63d0\\u73b0\\u660e\\u7ec6"},"words":{"all":{"value":"\\u5168\\u90e8"},"apply_10":{"value":"\\u5ba1\\u6838\\u4e2d"},"apply_20":{"value":"\\u5ba1\\u6838\\u901a\\u8fc7"},"apply_40":{"value":"\\u5df2\\u6253\\u6b3e"},"apply_30":{"value":"\\u9a73\\u56de"}}},"withdraw_apply":{"title":{"value":"\\u7533\\u8bf7\\u63d0\\u73b0"},"words":{"capital":{"value":"\\u53ef\\u63d0\\u73b0\\u4f63\\u91d1"},"money":{"value":"\\u63d0\\u73b0\\u91d1\\u989d"},"money_placeholder":{"value":"\\u8bf7\\u8f93\\u5165\\u8981\\u63d0\\u53d6\\u7684\\u91d1\\u989d"},"min_money":{"value":"\\u6700\\u4f4e\\u63d0\\u73b0\\u4f63\\u91d1"},"submit":{"value":"\\u63d0\\u4ea4\\u7533\\u8bf7"}}},"qrcode":{"title":{"value":"\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u7801"}}}', 10005, 1662619163);
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_user` (
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '分销商用户id',
  `real_name` varchar(30) NOT NULL DEFAULT '' COMMENT '姓名',
  `mobile` varchar(20) NOT NULL DEFAULT '' COMMENT '手机号',
...
(10002, '钟', '15019998211', '0.00', '0.00', '0.00', 0, 0, 0, 0, 0, 10001, 1650267191, 1650267191),
(10038, '11', '13000000000', '0.00', '0.00', '0.00', 0, 0, 0, 0, 0, 10001, 1659339158, 1659339158),
(10043, '分销测试', '13888888888', '0.00', '0.00', '0.00', 0, 0, 0, 0, 0, 10005, 1662619571, 1662619571);
...
CREATE TABLE IF NOT EXISTS `yoshop_dealer_withdraw` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT
1066,1074,1081,1088,1093,1098,1110,1118,1127,1136,1142,1150,1155,1160,1169,1183,1190,1196,1209,1222,1234,1245,1253,1264,1274,1279,1285,1299,1302,1306,1325,1339,1350,1362,1376,1387,1399,1408,1415,1421,1434,1447,1459,1466,1471,1476,1479,1492,1504,1513,1522,1533,1546,1556,1572,1583,1593,1599,1612,1623,1630,1637,1643,1650,1664,1674,1685,1696,1707,1710,1724,1731,1740,1754,1764,1768,1774,1782,1791,1802,1809,1813,1822,1828,1838,1848,1854,1867,1880,1890,1900,1905,1912,1924,1936,1949,1955,1965,1977,1988,1999,2003,2011,2017,2025,2035,2041,2050,2056,2065,2070,2077,2082,2091,2123,2146,2150,2156,2163,2177,2189,2207,2215,2220,2225,2230,2236,2245,2258,2264,2276,2283,2292,2297,2302,2306,4018,2324,2363,2368,2388,2395,2401,2409,2416,2426,2434,2440,2446,2458,2468,2475,2486,2493,2501,2510,2516,2521,2535,2554,2573,2584,2589,2604,2611,2620,2631,2640,2657,2671,2686,2696,2706,2712,2724,2730,2741,2750,2761,2775,2784,2788,2801,2807,2812,2899,2913,2918,2931,2946,2958,2972,2984,2997,3008,3016,3023,3032,3036,3039,3045,3053,3058,3065,3073,3081,3090,3098,3108,3117,3127,3135,3142,3147,3152,3158,3165,3172,3179,3186,3190,3196,3202,3326,3339,3378,3386,3416,3454,3458,3461,3491,3504,3518,3532,3551,3578,3592,3613,3632,3666,3683,3697,3704,3711', 1, '10.00', 1, '10.00', 10005, 1663053667);
...
CREATE TABLE IF NOT EXISTS `yoshop_express` (
...
(10010, '测试物流', '1000100', 100, 10005, 1662604343, 1662604343);
...
CREATE TABLE IF NOT EXISTS `yoshop_goods` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10012 DEFAULT CHARSET=utf8 COMMENT='商品记录表';

--
-- 转存表中的数据 `yoshop_goods`
--

INSERT INTO `yoshop_goods` (`goods_id`, `goods_name`, `selling_point`, `category_id`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `is_points_gift`, `is_points_discount`, `is_enable_grade`, `is_alone_grade`, `alone_grade_equity`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '【正品保证】CHANEL 香奈儿可可小姐香水 coco香水女士', '', 10002, 10, 20, '&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202202171733166a57a0891.png&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10001, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10001, 1644976534, 1645090557),
(10002, '【正品保证】TOM FORD 汤姆福特桃涩花蜜TF苦桃香水女士大牌正品', '', 10002, 10, 20, '&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220218145405e4c7e9737.png&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 0, 100, 10001, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10001, 1644979737, 1645167251),
(10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', '', 10002, 10, 20, '&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220218150853c0f648470.png&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 1, 100, 10001, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10001, 1644979749, 1645168139),
(10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', '1111', 10002, 10, 20, '&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 0, 1, 100, 10001, 1, 1, 1, 0, NULL, 1, 20, '1.00', '1.00', '1.00', 10, 0, 10001, 1644979755, 1650267098),
(10005, '测试', '', 10013, 10, 20, '', 0, 2, 100, 10003, 1, 1, 1, 0, '{"10001":"0","10002":"0","10003":"0","10004":"0","10005":"0"}', 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662541857, 1663147783),
(10006, '测试', '', 10014, 10, 20, '&lt;p&gt;测试测试&lt;/p&gt;', 0, 0, 100, 10003, 1, 1, 1, 0, '{"10001":"0","10002":"0","10003":"0","10004":"0","10005":"0"}', 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662544536, 1663147768),
(10007, '测试二', '', 10013, 10, 20, '', 0, 9, 100, 10003, 1, 1, 1, 0, '{"10001":"0","10002":"0","10003":"0","10004":"0","10005":"0"}', 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662601904, 1663569870),
(10008, '砍价测试', '', 10014, 10, 20, '', 0, 0, 100, 10003, 1, 1, 1, 0, '{"10001":"0","10002":"0","10003":"0","10004":"0","10005":"0"}', 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662603363, 1663147808),
(10009, '秒杀测试', '', 10014, 10, 20, '', 0, 0, 100, 10003, 1, 1, 1, 0, '{"10001":"0","10002":"0","10003":"0","10004":"0","10005":"0"}', 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662603487, 1663563337),
(10010, '迪士尼医生玩具套装仿真听诊器医护工具台角色扮演互动礼物过家家套装', '仿真听诊器医护工具台', 10015, 10, 20, '&lt;p&gt;&lt;br/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151805ad5b17148.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202209131518051dd719090.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202209131518050848b2277.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151805ca2a57596.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202209131518052ecae8261.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151805051751345.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151806224f66296.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151806a371e3842.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/2022091315180629f049766.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151807a49cf0081.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202209131518073723e7490.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151808199ad8684.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/202209131518084e1b79647.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151808dd59b6835.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/2022091315180976c7e0976.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151809d90c54904.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151809aa2ae1209.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151809da9fa3492.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151809cc2bc3233.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;img src=&quot;https://saas.weiyinstudio.com/uploads/20220913151810d28cd6784.jpg&quot;/&gt;&lt;/p&gt;&lt;p&gt;&lt;br/&gt;&lt;/p&gt;', 69, 0, 100, 10004, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1663053999, 1663053999),
(10011, '测试', '', 10002, 10, 20, '', 0, 0, 100, 10001, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10001, 1663573617, 1663573617);
...
CREATE TABLE IF NOT EXISTS `yoshop_goods_image` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10054 DEFAULT CHARSET=utf8 COMMENT='商品图片记录表';
...
(10011, 10001, 10034, 10001, 1645090557),
(10012, 10001, 10038, 10001, 1645090557),
(10013, 10001, 10039, 10001, 1645090557),
(10021, 10002, 10033, 10001, 1645167251),
(10022, 10002, 10042, 10001, 1645167251),
(10023, 10002, 10043, 10001, 1645167251),
(10027, 10003, 10047, 10001, 1645168139),
(10028, 10003, 10046, 10001, 1645168139),
(10029, 10003, 10045, 10001, 1645168139),
(10033, 10004, 10051, 10001, 1650267098),
(10034, 10004, 10049, 10001, 1650267098),
(10035, 10004, 10050, 10001, 1650267098),
(10041, 10010, 10058, 10005, 1663053999),
(10042, 10010, 10057, 10005, 1663053999),
(10043, 10010, 10059, 10005, 1663053999),
(10044, 10010, 10061, 10005, 1663053999),
(10045, 10010, 10060, 10005, 1663053999),
(10048, 10007, 10097, 10005, 1663147751),
(10049, 10006, 10100, 10005, 1663147768),
(10050, 10005, 10099, 10005, 1663147783),
(10051, 10008, 10098, 10005, 1663147808),
(10052, 10009, 10091, 10005, 1663563337),
(10053, 10011, 10053, 10001, 1663573617);
...
CREATE TABLE IF NOT EXISTS `yoshop_goods_sku` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10034 DEFAULT CHARSET=utf8 COMMENT='商品规格表';
...
(10011, 10001, '0', 0, '123123', '899.00', '22.00', 55, 0, 1, 10001, 1645090557, 1645090557),
(10015, 10002, '0', 0, '123123', '2600.00', '2600.00', 55, 0, 1, 10001, 1645167251, 1645167251),
(10017, 10003, '0', 0, '123123', '1.00', '620.00', 54, 0, 1, 10001, 1645168139, 1645168139),
(10019, 10004, '0', 0, '123123', '1.00', '590.00', 54, 0, 1, 10001, 1650267098, 1650267098),
(10025, 10010, '0', 0, '', '98.00', '198.00', 2, 0, 0.75, 10005, 1663053999, 1663053999),
(10028, 10007, '0', 0, '', '1.00', '0.00', 3, 0, 1, 10005, 1663147751, 1663569870),
(10029, 10006, '0', 0, '', '45.00', '0.00', 23, 0, 2, 10005, 1663147768, 1663147768),
(10030, 10005, '0', 0, '', '12.00', '0.00', 121, 0, 1, 10005, 1663147783, 1663147783),
(10031, 10008, '0', 0, '', '60.00', '0.00', 26, 0, 1, 10005, 1663147808, 1663147808),
(10032, 10009, '0', 0, '', '1.00', '0.00', 20, 0, 1, 10005, 1663563337, 1663563337),
(10033, 10011, '0', 0, '', '12.00', '0.00', 12, 0, 12, 10001, 1663573617, 1663573617);
...
CREATE TABLE IF NOT EXISTS `yoshop_order` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10024 DEFAULT CHARSET=utf8 COMMENT='订单记录表';

--
-- 转存表中的数据 `yoshop_order`
--

INSERT INTO `yoshop_order` (`order_id`, `order_no`, `total_price`, `order_price`, `coupon_id`, `coupon_money`, `points_money`, `points_num`, `pay_price`, `update_price`, `buyer_remark`, `pay_type`, `pay_status`, `pay_time`, `delivery_type`, `extract_shop_id`, `extract_clerk_id`, `express_price`, `express_id`, `express_company`, `express_no`, `delivery_status`, `delivery_time`, `receipt_status`, `receipt_time`, `order_status`, `points_bonus`, `is_settled`, `transaction_id`, `is_comment`, `order_source`, `order_source_id`, `user_id`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '2022021656545410', '11.00', '1.00', 10001, '10.00', '0.00', 0, '1.00', '0.00', '', 10, 20, 1644999224, 10, 0, 0, '0.00', 10001, '', '12312312312', 20, 1644999332, 20, 1644999389, 30, 0, 1, '', 0, 10, 0, 10001, 0, 10001, 1644999224, 1645618519),
(10002, '2022030350491005', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10012, 0, 10001, 1646272930, 1646272995),
(10003, '2022041897102515', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 10, 20, 1650267035, 10, 0, 0, '0.00', 10009, '', '456', 20, 1650267057, 20, 1651154943, 30, 0, 1, '', 0, 10, 0, 10002, 0, 10001, 1650267034, 1652261924),
(10004, '2022042299495449', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650600860, 1650600935),
(10005, '2022042257565551', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650600873, 1650600997),
(10006, '2022042210151985', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10026, 0, 10001, 1650600926, 1650600981),
(10007, '2022042210298985', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650600927, 1650600996),
(10008, '2022042257515748', '2.00', '2.00', 0, '0.00', '0.00', 0, '2.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650600969, 1650600984),
(10009, '2022042299485157', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10026, 0, 10001, 1650600972, 1650876609),
(10010, '2022042297529853', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650627258, 1650677257),
(10011, '2022042454519710', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10025, 0, 10001, 1650767942, 1650876616),
(10012, '2022050550485648', '899.00', '899.00', 0, '0.00', '0.00', 0, '899.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10027, 0, 10001, 1651717938, 1652261924),
(10013, '2022050550971025', '1798.00', '1798.00', 0, '0.00', '0.00', 0, '1798.00', '0.00', '', 20, 10, 0, 10, 0, 0, '0.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10027, 0, 10001, 1651718882, 1652261924),
(10014, '2022090752555297', '12.00', '12.00', 0, '0.00', '0.00', 0, '13.00', '0.00', '', 10, 20, 1662555669, 10, 0, 0, '1.00', 10010, '', '100100', 20, 1662604359, 20, 1662604375, 30, 0, 1, '', 1, 10, 0, 10043, 0, 10005, 1662555572, 1663213137),
(10015, '2022090851989898', '5.00', '5.00', 0, '0.00', '0.00', 0, '10.00', '0.00', '', 10, 20, 1662604408, 10, 0, 0, '5.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1662604403, 1662604408),
(10016, '2022090849505710', '12.00', '12.00', 0, '0.00', '0.00', 0, '12.00', '0.00', '', 10, 20, 1662607425, 20, 10003, 0, '0.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1662607425, 1662607425),
(10017, '2022090856100579', '1.00', '1.00', 0, '0.00', '0.00', 0, '2.00', '0.00', '', 20, 10, 0, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1662628008, 1663030813),
(10018, '2022090851515710', '1.00', '1.00', 0, '0.00', '0.00', 0, '2.00', '0.00', '', 20, 10, 0, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1662629555, 1662629573),
(10019, '2022091910252514', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 20, 20, 1663563446, 20, 10003, 0, '0.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '4200001609202209191127808182', 0, 10, 0, 10046, 0, 10005, 1663563439, 1663563446),
(10020, '2022091910110250', '1.00', '1.00', 0, '0.00', '0.00', 0, '1.00', '0.00', '', 10, 20, 1663563471, 20, 10003, 0, '0.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10046, 0, 10005, 1663563470, 1663563471),
(10021, '2022091953574999', '1.00', '1.00', 0, '0.00', '0.00', 0, '2.00', '0.00', '', 20, 10, 0, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1663569589, 1663569589),
(10022, '2022091957535753', '1.00', '1.00', 0, '0.00', '0.00', 0, '2.00', '0.00', '', 10, 20, 1663569593, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1663569593, 1663569593),
(10023, '2022091952101102', '1.00', '0.80', 0, '0.00', '0.20', 2, '1.80', '0.00', '', 10, 20, 1663569870, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 10, 0, 0, '', 0, 10, 0, 10043, 0, 10005, 1663569860, 1663569870);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_address` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10021 DEFAULT CHARSET=utf8 COMMENT='订单收货地址记录表';
...
(10001, '啊啊啊', '13795233685', 1, 2, 3, '啊啊啊啊啊啊啊', 10001, 10001, 10001, 1644999224),
(10002, '袁欢', '15368707031', 2670, 2671, 2685, '云南经济管理学院（安宁校区）', 10002, 10012, 10001, 1646272930),
(10003, '钟先生', '15019998211', 1964, 2091, 0, '东莞市 莞城街道大屏幕集团东莞尾音信息科技有限公司', 10003, 10002, 10001, 1650267034),
(10004, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10004, 10025, 10001, 1650600860),
(10005, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10005, 10025, 10001, 1650600873),
(10006, '汪牡英', '18371538344', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10006, 10026, 10001, 1650600926),
(10007, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10007, 10025, 10001, 1650600927),
(10008, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10008, 10025, 10001, 1650600969),
(10009, '汪牡英', '18371538344', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10009, 10026, 10001, 1650600972),
(10010, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10010, 10025, 10001, 1650627258),
(10011, '刘菊红', '18727160701', 1709, 1822, 1823, '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10011, 10025, 10001, 1650767942),
(10012, '李玉', '17755674003', 351, 352, 353, '解放路15号解放路', 10012, 10027, 10001, 1651717938),
(10013, '李玉', '17755674003', 351, 352, 353, '解放路15号解放路', 10013, 10027, 10001, 1651718882),
(10014, '测试', '13888888888', 1964, 1965, 1966, '测试', 10014, 10043, 10005, 1662555572),
(10015, '测试', '13888888888', 1964, 1965, 1966, '测试', 10015, 10043, 10005, 1662604403),
(10016, '测试', '13888888888', 1964, 1965, 1966, '测试', 10017, 10043, 10005, 1662628008),
(10017, '测试', '13888888888', 1964, 1965, 1966, '测试', 10018, 10043, 10005, 1662629555),
(10018, '测试', '13888888888', 1964, 1965, 1966, '测试', 10021, 10043, 10005, 1663569589),
(10019, '测试', '13888888888', 1964, 1965, 1966, '测试', 10022, 10043, 10005, 1663569593),
(10020, '测试', '13888888888', 1964, 1965, 1966, '测试', 10023, 10043, 10005, 1663569860);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_extract` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10004 DEFAULT CHARSET=utf8 COMMENT='自提订单联系方式记录表';

--
-- 转存表中的数据 `yoshop_order_extract`
--

INSERT INTO `yoshop_order_extract` (`id`, `order_id`, `linkman`, `phone`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10016, '测试', '13888888888', 10043, 10005, 1662607425),
(10002, 10019, '1', '13345678900', 10046, 10005, 1663563439),
(10003, 10020, '1', '13345678900', 10046, 10005, 1663563470);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_goods` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10025 DEFAULT CHARSET=utf8 COMMENT='订单商品记录表';

--
-- 转存表中的数据 `yoshop_order_goods`
--

INSERT INTO `yoshop_order_goods` (`order_goods_id`, `goods_id`, `goods_name`, `image_id`, `deduct_stock_type`, `spec_type`, `spec_sku_id`, `goods_sku_id`, `goods_attr`, `content`, `goods_no`, `goods_price`, `line_price`, `goods_weight`, `is_user_grade`, `grade_ratio`, `grade_goods_price`, `grade_total_money`, `coupon_money`, `points_money`, `points_num`, `points_bonus`, `total_num`, `total_price`, `total_pay_price`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `is_comment`, `order_id`, `user_id`, `goods_source_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10003, '测试商品3', 10005, 20, 10, '0', 10007, '', '<p>测试商品测试商品</p>', '123123', '11.00', '22.00', 1, 0, 0, '0.00', '0.00', '10.00', '0.00', 0, 0, 1, '11.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10001, 10001, 0, 10001, 1644999224),
(10002, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10018, '', '<p><img src="https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png"/></p><p><br/></p>', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10002, 10012, 0, 10001, 1646272930),
(10003, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10018, '', '<p><img src="https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png"/></p><p><br/></p>', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10003, 10002, 0, 10001, 1650267035),
(10004, 10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', 10047, 20, 10, '0', 10017, '', '<p><img src="https://saas.weiyinstudio.com/uploads/20220218150853c0f648470.png"/></p><p><br/></p>', '123123', '1.00', '620.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10004, 10025, 0, 10001, 1650600860),
(10005, 10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', 10047, 20, 10, '0', 10017, '', '<p><img src="https://saas.weiyinstudio.com/uploads/20220218150853c0f648470.png"/></p><p><br/></p>', '123123', '1.00', '620.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10005, 10025, 0, 10001, 1650600873),
(10006, 10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', 10047, 20, 10, '0', 10017, '', '<p><img src="https://saas.weiyinstudio.com/uploads/20220218150853c0f648470.png"/></p><p><br/></p>', '123123', '1.00', '620.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10006, 10026, 0, 10001, 1650600926),
(10007, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10019, '', '<p><img src="https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png"/></p><p><br/></p>', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 1, 20, '1.00', '1.00', '1.00', 0, 10007, 10025, 0, 10001, 1650600927),
(10008, 10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', 10047, 20, 10, '0', 10017, '', '', '123123', '1.00', '620.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10008, 10025, 0, 10001, 1650600969),
(10009, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10019, '', '', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 1, 20, '1.00', '1.00', '1.00', 0, 10008, 10025, 0, 10001, 1650600969),
(10010, 10003, '【正品保证】TOM FORD 奢金柔光双色腮红04 TF腮红', 10047, 20, 10, '0', 10017, '', '<p><img src="https://saas.weiyinstudio.com/uploads/20220218150853c0f648470.png"/></p><p><br/></p>', '123123', '1.00', '620.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10009, 10026, 0, 10001, 1650600972),
(10011, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10019, '', '<p><img src="https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png"/></p><p><br/></p>', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 1, 20, '1.00', '1.00', '1.00', 0, 10010, 10025, 0, 10001, 1650627258),
(10012, 10004, '【正品保证】TOM FORD 汤姆福特闪耀焕魅妆前乳TF妆前乳', 10051, 20, 10, '0', 10019, '', '<p><img src="https://saas.weiyinstudio.com/uploads/2022021815213106aa42332.png"/></p><p><br/></p>', '123123', '1.00', '590.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 1, 20, '1.00', '1.00', '1.00', 0, 10011, 10025, 0, 10001, 1650767942),
(10013, 10001, '【正品保证】CHANEL 香奈儿可可小姐香水 coco香水女士', 10034, 20, 10, '0', 10011, '', '<p><img src="https://saas.weiyinstudio.com/uploads/202202171733166a57a0891.png"/></p><p><br/></p>', '123123', '899.00', '22.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '899.00', '899.00', 0, 10, '0.00', '0.00', '0.00', 0, 10012, 10027, 0, 10001, 1651717938),
(10014, 10001, '【正品保证】CHANEL 香奈儿可可小姐香水 coco香水女士', 10034, 20, 10, '0', 10011, '', '', '123123', '899.00', '22.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 2, '1798.00', '1798.00', 0, 10, '0.00', '0.00', '0.00', 0, 10013, 10027, 0, 10001, 1651718882),
(10015, 10005, '测试', 10054, 20, 10, '0', 10020, '', '', '', '12.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '12.00', '12.00', 0, 10, '0.00', '0.00', '0.00', 1, 10014, 10043, 0, 10005, 1662555572),
(10016, 10007, '测试二', 10054, 20, 10, '0', 10022, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 5, '5.00', '5.00', 0, 10, '0.00', '0.00', '0.00', 0, 10015, 10043, 0, 10005, 1662604403),
(10017, 10005, '测试', 10054, 20, 10, '0', 10020, '', '', '', '12.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '12.00', '12.00', 0, 10, '0.00', '0.00', '0.00', 0, 10016, 10043, 0, 10005, 1662607425),
(10018, 10007, '测试二', 10054, 20, 10, '0', 10022, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10017, 10043, 0, 10005, 1662628008),
(10019, 10007, '测试二', 10054, 20, 10, '0', 10022, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10018, 10043, 0, 10005, 1662629555),
(10020, 10007, '测试二', 10097, 20, 10, '0', 10028, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10019, 10046, 0, 10005, 1663563439),
(10021, 10007, '测试二', 10097, 20, 10, '0', 10028, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10020, 10046, 0, 10005, 1663563470),
(10022, 10007, '测试二', 10097, 20, 10, '0', 10028, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10021, 10043, 0, 10005, 1663569589),
(10023, 10007, '测试二', 10097, 20, 10, '0', 10028, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '1.00', '1.00', 0, 10, '0.00', '0.00', '0.00', 0, 10022, 10043, 0, 10005, 1663569593),
(10024, 10007, '测试二', 10097, 20, 10, '0', 10028, '', '', '', '1.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.20', 2, 0, 1, '1.00', '0.80', 0, 10, '0.00', '0.00', '0.00', 0, 10023, 10043, 0, 10005, 1663569860);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_refund` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='售后单记录表';

--
-- 转存表中的数据 `yoshop_order_refund`
--

INSERT INTO `yoshop_order_refund` (`order_refund_id`, `order_id`, `order_goods_id`, `user_id`, `type`, `apply_desc`, `is_agree`, `refuse_desc`, `refund_money`, `is_user_send`, `send_time`, `express_id`, `express_no`, `is_receipt`, `status`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 10001, 10001, 10, '退钱！', 10, '', '1.00', 1, 1645000900, '10004', '5641564564564654', 1, 20, 10001, 1645000385, 1645083266),
(10002, 10014, 10015, 10043, 20, '测试换货', 10, '', '0.00', 0, 0, '', '', 0, 20, 10005, 1662604558, 1662604584);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_refund_address` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='售后单退货地址记录表';

--
-- 转存表中的数据 `yoshop_order_refund_address`
--

INSERT INTO `yoshop_order_refund_address` (`id`, `order_refund_id`, `name`, `phone`, `detail`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, '黄老板', '13790666000', '东莞尾音', 10001, 1645000560),
(10002, 10002, '测试退货', '13888888888', '测试地址', 10005, 1662604584);
...
CREATE TABLE IF NOT EXISTS `yoshop_order_refund_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_refund_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '售后单id',
  `image_id` int(11) NOT NULL DEFAULT '0' COMMENT '图片id(关联文件记录表)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
CREATE TABLE IF NOT EXISTS `yoshop_printer` (
...
CREATE TABLE IF NOT EXISTS `yoshop_recharge_order` (
  `order_id` int(11) unsigned NOT NULL COMMENT '订单id',
  `order_no` varchar(20) NOT NULL DEFAULT '' COMMENT '订单号',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10025 DEFAULT CHARSET=utf8 COMMENT='用户充值订单表';

--
-- 转存表中的数据 `yoshop_recharge_order`
--

INSERT INTO `yoshop_recharge_order` (`order_id`, `order_no`, `user_id`, `recharge_type`, `plan_id`, `pay_price`, `gift_money`, `actual_money`, `pay_status`, `pay_time`, `transaction_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'RC2022030354102509', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272950, 1646272950),
(10002, 'RC2022030356565452', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272952, 1646272952),
(10003, 'RC2022030357544998', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272953, 1646272953),
(10004, 'RC2022030357100974', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272953, 1646272953),
(10005, 'RC2022030397564997', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272954, 1646272954),
(10006, 'RC2022030397101511', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272954, 1646272954),
(10007, 'RC2022030398575397', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272955, 1646272955),
(10008, 'RC2022030310297569', 10012, 10, 0, '5.00', '0.00', '5.00', 10, 0, '', 10001, 1646272959, 1646272959),
(10009, 'RC2022030348975751', 10012, 10, 0, '5.00', '0.00', '5.00', 10, 0, '', 10001, 1646272960, 1646272960),
(10010, 'RC2022030352485756', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272964, 1646272964),
(10011, 'RC2022030352100484', 10012, 10, 0, '1.00', '0.00', '1.00', 10, 0, '', 10001, 1646272964, 1646272964),
(10012, 'RC2022050550565057', 10027, 10, 0, '1000.00', '0.00', '1000.00', 10, 0, '', 10001, 1651718578, 1651718578),
(10013, 'RC2022050552504854', 10027, 10, 0, '1000.00', '0.00', '1000.00', 10, 0, '', 10001, 1651718580, 1651718580),
(10014, 'RC2022050552101511', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718676, 1651718676),
(10015, 'RC2022050554504855', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718678, 1651718678),
(10016, 'RC2022050554995010', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718678, 1651718678),
(10017, 'RC2022050554102509', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718678, 1651718678),
(10018, 'RC2022050555549910', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718679, 1651718679),
(10019, 'RC2022050555995153', 10027, 10, 0, '1880.00', '0.00', '1880.00', 10, 0, '', 10001, 1651718679, 1651718679),
(10020, 'RC2022080156511025', 10038, 10, 0, '20.00', '0.00', '20.00', 10, 0, '', 10001, 1659340504, 1659340504),
(10021, 'RC2022080197525399', 10038, 10, 0, '20.00', '0.00', '20.00', 10, 0, '', 10001, 1659340506, 1659340506),
(10022, 'RC2022080197100995', 10038, 10, 0, '20.00', '0.00', '20.00', 10, 0, '', 10001, 1659340506, 1659340506),
(10023, 'RC2022091498975053', 10046, 10, 0, '100.00', '0.00', '100.00', 10, 0, '', 10005, 1663124875, 1663124875),
(10024, 'RC2022091551525048', 10043, 10, 0, '20.00', '0.00', '20.00', 10, 0, '', 10005, 1663209251, 1663209251);
...
CREATE TABLE IF NOT EXISTS `yoshop_recharge_order_plan` (
...
CREATE TABLE IF NOT EXISTS `yoshop_recharge_plan` (
  `plan_id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_return_address` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='退货地址记录表';

--
-- 转存表中的数据 `yoshop_return_address`
--

INSERT INTO `yoshop_return_address` (`address_id`, `name`, `phone`, `detail`, `sort`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '黄老板', '13790666000', '东莞尾音', 100, 0, 10001, 1645000551, 1645000551),
(10002, '测试退货', '13888888888', '测试地址', 100, 0, 10005, 1662604534, 1662604534);
...
('full_free', '满额包邮设置', '{"is_open":"1","money":"50","notin_goods":["10004"],"notin_region":{"province":["3738","3716","3206","3325"],"citys":["3739","3745","3747","3999","3207","3216","3221","3225","3229","3237","3242","3252","3262","3267","3280","3289","3301","3309","3317","3326","3339","3378","3386","3416","3454","3458","3461","3491","3504","3518","3532","3551","3578","3592","3613","3632","3666","3683","3697","3704","3711"]}}', 10001, 1645080598),
('full_free', '满额包邮设置', '{"is_open":"0","money":"","notin_region":{"province":[],"citys":[],"treeData":[]},"notin_goods":[]}', 10002, 1644830175),
('full_free', '满额包邮设置', '{"is_open":"0","money":"","notin_region":{"province":[],"citys":[],"treeData":[]},"notin_goods":[]}', 10003, 1644895639),
('full_free', '满额包邮设置', '{"is_open":"0","money":"","notin_region":{"province":[],"citys":[],"treeData":[]},"notin_goods":[]}', 10004, 1645002493),
('full_free', '满额包邮设置', '{"is_open":"0","money":"","notin_region":{"province":[],"citys":[],"treeData":[]},"notin_goods":[]}', 10005, 1662540436),
('points', '积分设置', '{"points_name":"\\u79ef\\u5206","is_shopping_gift":"0","gift_ratio":"100","is_shopping_discount":"0","discount":{"discount_ratio":"0.01","full_order_price":"100.00","max_money_ratio":"10"},"describe":"a) \\u79ef\\u5206\\u4e0d\\u53ef\\u5151\\u73b0\\u3001\\u4e0d\\u53ef\\u8f6c\\u8ba9,\\u4ec5\\u53ef\\u5728\\u672c\\u5e73\\u53f0\\u4f7f\\u7528;\\nb) \\u60a8\\u5728\\u672c\\u5e73\\u53f0\\u53c2\\u52a0\\u7279\\u5b9a\\u6d3b\\u52a8\\u4e5f\\u53ef\\u4f7f\\u7528\\u79ef\\u5206,\\u8be6\\u7ec6\\u4f7f\\u7528\\u89c4\\u5219\\u4ee5\\u5177\\u4f53\\u6d3b\\u52a8\\u65f6\\u7684\\u89c4\\u5219\\u4e3a\\u51c6;\\nc) \\u79ef\\u5206\\u7684\\u6570\\u503c\\u7cbe\\u786e\\u5230\\u4e2a\\u4f4d(\\u5c0f\\u6570\\u70b9\\u540e\\u5168\\u90e8\\u820d\\u5f03,\\u4e0d\\u8fdb\\u884c\\u56db\\u820d\\u4e94\\u5165)\\nd) \\u4e70\\u5bb6\\u5728\\u5b8c\\u6210\\u8be5\\u7b14\\u4ea4\\u
('printer', '小票打印机设置', '{"is_open":"0","printer_id":"","order_status":[]}', 10002, 1644830175),
('printer', '小票打印机设置', '{"is_open":"0","printer_id":"","order_status":[]}', 10003, 1644895639),
('printer', '小票打印机设置', '{"is_open":"0","printer_id":"","order_status":[]}', 10004, 1645002493),
('printer', '小票打印机设置', '{"is_open":"0","printer_id":"","order_status":[]}', 10005, 1662540436),
('recharge', '充值设置', '{"is_entrance":"1","is_custom":"1","is_match_plan":"1","describe":"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd"}', 10001, 1645069049),
('recharge', '用户充值设置', '{"is_entrance":"1","is_custom":"1","is_match_plan":"1","describe":"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd400-000-1234"}', 10002, 1644830175),
('recharge', '用户充值设置', '{"is_entrance":"1","is_custom":"1","is_match_plan":"1","describe":"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd400-000-1234"}', 10003, 1644895639),
('recharge', '用户充值设置', '{"is_entrance":"1","is_custom":"1","is_match_plan":"1","describe":"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd400-000-1234"}', 10004, 1645002493),
('recharge', '用户充值设置', '{"is_entrance":"1","is_custom":"1","is_match_plan":"1","describe":"1. \\u8d26\\u6237\\u5145\\u503c\\u4ec5\\u9650\\u5fae\\u4fe1\\u5728\\u7ebf\\u65b9\\u5f0f\\u652f\\u4ed8\\uff0c\\u5145\\u503c\\u91d1\\u989d\\u5b9e\\u65f6\\u5230\\u8d26\\uff1b\\n2. \\u8d26\\u6237\\u5145\\u503c\\u5957\\u9910\\u8d60\\u9001\\u7684\\u91d1\\u989d\\u5373\\u65f6\\u5230\\u8d26\\uff1b\\n3. \\u8d26\\u6237\\u4f59\\u989d\\u6709\\u6548\\u671f\\uff1a\\u81ea\\u5145\\u503c\\u65e5\\u8d77\\u81f3\\u7528\\u5b8c\\u5373\\u6b62\\uff1b\\n4. \\u82e5\\u6709\\u5176\\u5b83\\u7591\\u95ee\\uff0c\\u53ef\\u62e8\\u6253\\u5ba2\\u670d\\u7535\\u8bdd400-000-1234"}', 10005, 1662540436),
('sms', '短信通知', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"","AccessKeySecret":"","sign":"\\u8424\\u706b\\u79d1\\u6280","order_pay":{"is_enable":"0","template_code":"","accept_phone":""}}}}', 10002, 1644830175),
('sms', '短信通知', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"","AccessKeySecret":"","sign":"\\u8424\\u706b\\u79d1\\u6280","order_pay":{"is_enable":"0","template_code":"","accept_phone":""}}}}', 10003, 1644895639),
('sms', '短信通知', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"","AccessKeySecret":"","sign":"\\u8424\\u706b\\u79d1\\u6280","order_pay":{"is_enable":"0","template_code":"","accept_phone":""}}}}', 10004, 1645002493),
('sms', '短信通知', '{"default":"aliyun","engine":{"aliyun":{"AccessKeyId":"","AccessKeySecret":"","sign":"\\u8424\\u706b\\u79d1\\u6280","order_pay":{"is_enable":"0","template_code":"","accept_phone":""}}}}', 10005, 1662540436),
...
('storage', '上传设置', '{"default":"local","engine":{"local":[],"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":"http:\\/\\/"},"aliyun":{"bucket":"","access_key_id":"","access_key_secret":"","domain":"http:\\/\\/"},"qcloud":{"bucket":"","region":"","secret_id":"","secret_key":"","domain":"http:\\/\\/"}}}', 10002, 1644830175),
('storage', '上传设置', '{"default":"local","engine":{"local":[],"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":"http:\\/\\/"},"aliyun":{"bucket":"","access_key_id":"","access_key_secret":"","domain":"http:\\/\\/"},"qcloud":{"bucket":"","region":"","secret_id":"","secret_key":"","domain":"http:\\/\\/"}}}', 10003, 1644895639),
('storage', '上传设置', '{"default":"local","engine":{"local":[],"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":"http:\\/\\/"},"aliyun":{"bucket":"","access_key_id":"","access_key_secret":"","domain":"http:\\/\\/"},"qcloud":{"bucket":"","region":"","secret_id":"","secret_key":"","domain":"http:\\/\\/"}}}', 10004, 1645002493),
('storage', '上传设置', '{"default":"local","engine":{"local":[],"qiniu":{"bucket":"","access_key":"","secret_key":"","domain":"http:\\/\\/"},"aliyun":{"bucket":"","access_key_id":"","access_key_secret":"","domain":"http:\\/\\/"},"qcloud":{"bucket":"","region":"","secret_id":"","secret_key":"","domain":"http:\\/\\/"}}}', 10005, 1662540436),
('store', '商城设置', '{"name":"\\u5546\\u57ce\\u6d4b\\u8bd5","delivery_type":["10"],"kuaidi100":{"customer":"","key":""}}', 10001, 1661139226),
('store', '商城设置', '{"name":"\\u6d4b\\u8bd5\\u5e97","delivery_type":[10,20],"kuaidi100":{"customer":"","key":""}}', 10002, 1644830175),
('store', '商城设置', '{"name":"\\u6d4b\\u8bd5\\u5e97","delivery_type":[10,20],"kuaidi100":{"customer":"","key":""}}', 10003, 1644895639),
('store', '商城设置', '{"name":"\\u5c3e\\u97f3\\u4fe1\\u606f","delivery_type":["10","20"],"kuaidi100":{"customer":"","key":""}}', 10004, 1661137071),
('store', '商城设置', '{"name":"\\u7ebd\\u897f\\u5361\\u6c7d\\u8f66\\u5c0f\\u9547","delivery_type":[10,20],"kuaidi100":{"customer":"","key":""}}', 10005, 1662540436),
('submsg', '小程序订阅消息', '{"order":{"payment":{"template_id":"","keywords":["character_string1","time2","amount4","thing3"],"title":"\\u65b0\\u8ba2\\u5355\\u63d0\\u9192"},"delivery":{"template_id":"","keywords":["character_string1","thing2","name12","thing11","thing17"],"title":"\\u8ba2\\u5355\\u53d1\\u8d27\\u901a\\u77e5"},"refund":{"template_id":"","keywords":["phrase1","thing6","character_string2","date3","thing4"],"title":"\\u552e\\u540e\\u72b6\\u6001\\u901a\\u77e5"}},"sharing":{"active_status":{"template_id":"","keywords":["thing1","amount5","number7","thing3","thing6"],"title":"\\u62fc\\u56e2\\u8fdb\\u5ea6\\u901a\\u77e5"}},"dealer":{"apply":{"template_id":"","keywords":["date1","phrase2","date3","thing4"],"title":"\\u4ee3\\u7406\\u5546\\u5165\\u9a7b\\u5ba1\\u6838\\u901a\\u77e5"},"withdraw_01":{"template_id":"","keywords":["amount1","thing3","thing4"],"title":"\\u63d0\\u73b0\\u6210\\u529f\\u901a\\u77e5"},"withdraw_02":{"template_id":"","keywords":["amount1","time3","thing4"],"title":"\\u63d0\\u73b0\\u5931\\u8d25\\u901a\\u77e5"}}}', 10002, 1644830175),
('submsg', '小程序订阅消息', '{"order":{"payment":{"template_id":"","keywords":["character_string1","time2","amount4","thing3"],"title":"\\u65b0\\u8ba2\\u5355\\u63d0\\u9192"},"delivery":{"template_id":"","keywords":["character_string1","thing2","name12","thing11","thing17"],"title":"\\u8ba2\\u5355\\u53d1\\u8d27\\u901a\\u77e5"},"refund":{"template_id":"","keywords":["phrase1","thing6","character_string2","date3","thing4"],"title":"\\u552e\\u540e\\u72b6\\u6001\\u901a\\u77e5"}},"sharing":{"active_status":{"template_id":"","keywords":["thing1","amount5","number7","thing3","thing6"],"title":"\\u62fc\\u56e2\\u8fdb\\u5ea6\\u901a\\u77e5"}},"dealer":{"apply":{"template_id":"","keywords":["date1","phrase2","date3","thing4"],"title":"\\u4ee3\\u7406\\u5546\\u5165\\u9a7b\\u5ba1\\u6838\\u901a\\u77e5"},"withdraw_01":{"template_id":"","keywords":["amount1","thing3","thing4"],"title":"\\u63d0\\u73b0\\u6210\\u529f\\u901a\\u77e5"},"withdraw_02":{"template_id":"","keywords":["amount1","time3","thing4"],"title":"\\u63d0\\u73b0\\u5931\\u8d25\\u901a\\u77e5"}}}', 10003, 1644895639),
('submsg', '小程序订阅消息', '{"order":{"payment":{"template_id":"","keywords":["character_string1","time2","amount4","thing3"],"title":"\\u65b0\\u8ba2\\u5355\\u63d0\\u9192"},"delivery":{"template_id":"","keywords":["character_string1","thing2","name12","thing11","thing17"],"title":"\\u8ba2\\u5355\\u53d1\\u8d27\\u901a\\u77e5"},"refund":{"template_id":"","keywords":["phrase1","thing6","character_string2","date3","thing4"],"title":"\\u552e\\u540e\\u72b6\\u6001\\u901a\\u77e5"}},"sharing":{"active_status":{"template_id":"","keywords":["thing1","amount5","number7","thing3","thing6"],"title":"\\u62fc\\u56e2\\u8fdb\\u5ea6\\u901a\\u77e5"}},"dealer":{"apply":{"template_id":"","keywords":["date1","phrase2","date3","thing4"],"title":"\\u4ee3\\u7406\\u5546\\u5165\\u9a7b\\u5ba1\\u6838\\u901a\\u77e5"},"withdraw_01":{"template_id":"","keywords":["amount1","thing3","thing4"],"title":"\\u63d0\\u73b0\\u6210\\u529f\\u901a\\u77e5"},"withdraw_02":{"template_id":"","keywords":["amount1","time3","thing4"],"title":"\\u63d0\\u73b0\\u5931\\u8d25\\u901a\\u77e5"}}}', 10004, 1645002493),
('submsg', '小程序订阅消息', '{"order":{"payment":{"template_id":"","keywords":["character_string1","time2","amount4","thing3"],"title":"\\u65b0\\u8ba2\\u5355\\u63d0\\u9192"},"delivery":{"template_id":"","keywords":["character_string1","thing2","name12","thing11","thing17"],"title":"\\u8ba2\\u5355\\u53d1\\u8d27\\u901a\\u77e5"},"refund":{"template_id":"","keywords":["phrase1","thing6","character_string2","date3","thing4"],"title":"\\u552e\\u540e\\u72b6\\u6001\\u901a\\u77e5"}},"sharing":{"active_status":{"template_id":"","keywords":["thing1","amount5","number7","thing3","thing6"],"title":"\\u62fc\\u56e2\\u8fdb\\u5ea6\\u901a\\u77e5"}},"dealer":{"apply":{"template_id":"","keywords":["date1","phrase2","date3","thing4"],"title":"\\u4ee3\\u7406\\u5546\\u5165\\u9a7b\\u5ba1\\u6838\\u901a\\u77e5"},"withdraw_01":{"template_id":"","keywords":["amount1","thing3","thing4"],"title":"\\u63d0\\u73b0\\u6210\\u529f\\u901a\\u77e5"},"withdraw_02":{"template_id":"","keywords":["amount1","time3","thing4"],"title":"\\u63d0\\u73b0\\u5931\\u8d25\\u901a\\u77e5"}}}', 10005, 1662540436),
('trade', '交易设置', '{"order":{"close_days":"3","receive_days":"10","refund_days":"7"},"freight_rule":"10"}', 10002, 1644830175),
('trade', '交易设置', '{"order":{"close_days":"3","receive_days":"10","refund_days":"7"},"freight_rule":"10"}', 10003, 1644895639),
('trade', '交易设置', '{"order":{"close_days":"3","receive_days":"10","refund_days":"7"},"freight_rule":"10"}', 10004, 1645002493),
('trade', '交易设置', '{"order":{"close_days":"3","receive_days":"10","refund_days":"7"},"freight_rule":"10"}', 10005, 1662540436);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_active` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团拼单记录表';

--
-- 转存表中的数据 `yoshop_sharing_active`
--

INSERT INTO `yoshop_sharing_active` (`active_id`, `goods_id`, `people`, `actual_people`, `creator_id`, `end_time`, `status`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 2, 1, 10043, 1662689581, 30, 10005, 1662603181, 1662705690);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_active_users` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团拼单成员记录表';

--
-- 转存表中的数据 `yoshop_sharing_active_users`
--

INSERT INTO `yoshop_sharing_active_users` (`id`, `active_id`, `order_id`, `user_id`, `is_creator`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 10001, 10043, 1, 10005, 1662603181);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_category` (
  `category_id` int(11) unsigned NOT NULL COMMENT '商品分类id',
  `name` varchar(50) NOT NULL DEFAULT '' COMMENT '分类名称',
  `parent_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '上级分类id',
  `image_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '分类图片id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团商品分类表';
...
(10001, '拼团分类测试一', 0, 0, 100, 10005, 1662603122, 1662603122);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_comment` (
  `comment_id` int(11) unsigned NOT NULL COMMENT '评价id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '拼团订单id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '拼团商品id',
  `order_goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单商品id',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_comment_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `comment_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '评价id',
  `image_id` int(11) NOT NULL DEFAULT '0' COMMENT '图片id(关联文件记录表)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_goods` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团商品记录表';

--
-- 转存表中的数据 `yoshop_sharing_goods`
--

INSERT INTO `yoshop_sharing_goods` (`goods_id`, `goods_name`, `category_id`, `selling_point`, `people`, `group_time`, `is_alone`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `is_points_gift`, `is_points_discount`, `is_enable_grade`, `is_alone_grade`, `alone_grade_equity`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '拼团测试', 10001, '', 2, 24, 0, 10, 20, '', 0, 1, 100, 10003, 1, 1, 1, 0, NULL, 0, 10, '0.00', '0.00', '0.00', 10, 0, 10005, 1662603155, 1662603181);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_goods_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `image_id` int(11) NOT NULL COMMENT '图片id(关联文件记录表)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='商品图片记录表';
...
(10001, 10001, 10054, 10005, 1662603155);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_goods_sku` (
  `goods_sku_id` int(11) unsigned NOT NULL COMMENT '商品规格id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `spec_sku_id` varchar(255) NOT NULL DEFAULT '0' COMMENT '商品sku记录索引(由规格id组成)',
  `image_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '规格图片id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团商品规格表';
...
(10001, 10001, '0', 0, '', '2.00', '0.00', '0.00', 11, 0, 1, 10005, 1662603155, 1662603181);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_goods_spec_rel` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `spec_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '规格组id',
  `spec_value_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '规格值id',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order` (
  `order_id` int(11) unsigned NOT NULL COMMENT '订单id',
  `order_no` varchar(20) NOT NULL DEFAULT '' COMMENT '订单号',
  `total_price` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '商品总金额(不含优惠折扣)',
  `order_price` decimal(10,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单金额(含优惠折扣)',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='订单记录表';

--
-- 转存表中的数据 `yoshop_sharing_order`
--

INSERT INTO `yoshop_sharing_order` (`order_id`, `order_no`, `total_price`, `order_price`, `order_type`, `active_id`, `coupon_id`, `coupon_money`, `points_money`, `points_num`, `pay_price`, `update_price`, `buyer_remark`, `pay_type`, `pay_status`, `pay_time`, `delivery_type`, `extract_shop_id`, `extract_clerk_id`, `express_price`, `express_id`, `express_company`, `express_no`, `delivery_status`, `delivery_time`, `receipt_status`, `receipt_time`, `order_status`, `points_bonus`, `is_settled`, `is_refund`, `transaction_id`, `is_comment`, `user_id`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '2022090810053549', '2.00', '2.00', 20, 10001, 0, '0.00', '0.00', 0, '3.00', '0.00', '', 10, 20, 1662603181, 10, 0, 0, '1.00', 0, '', '', 10, 0, 10, 0, 20, 0, 0, 1, '', 0, 10043, 0, 10005, 1662603181, 1662705690);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_address` (
  `order_address_id` int(11) unsigned NOT NULL COMMENT '地址id',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话',
  `province_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '所在省份id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='拼团订单收货地址记录表';

--
-- 转存表中的数据 `yoshop_sharing_order_address`
--

INSERT INTO `yoshop_sharing_order_address` (`order_address_id`, `name`, `phone`, `province_id`, `city_id`, `region_id`, `detail`, `order_id`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, '测试', '13888888888', 1964, 1965, 1966, '测试', 10001, 10043, 10005, 1662603181);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_extract` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单id',
  `linkman` varchar(30) NOT NULL DEFAULT '' COMMENT '联系人姓名',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_goods` (
  `order_goods_id` int(11) unsigned NOT NULL COMMENT '主键id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '拼团商品id',
  `goods_name` varchar(255) NOT NULL DEFAULT '' COMMENT '商品名称',
  `image_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品封面图id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='订单商品记录表';

--
-- 转存表中的数据 `yoshop_sharing_order_goods`
--

INSERT INTO `yoshop_sharing_order_goods` (`order_goods_id`, `goods_id`, `goods_name`, `image_id`, `selling_point`, `people`, `group_time`, `is_alone`, `deduct_stock_type`, `spec_type`, `spec_sku_id`, `goods_sku_id`, `goods_attr`, `content`, `goods_no`, `goods_price`, `line_price`, `goods_weight`, `is_user_grade`, `grade_ratio`, `grade_goods_price`, `grade_total_money`, `coupon_money`, `points_money`, `points_num`, `points_bonus`, `total_num`, `total_price`, `total_pay_price`, `is_ind_dealer`, `dealer_money_type`, `first_money`, `second_money`, `third_money`, `is_comment`, `order_id`, `user_id`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, '拼团测试', 10054, '', 2, 24, 0, 20, 10, '0', 10001, '', '', '', '0.00', '0.00', 1, 0, 0, '0.00', '0.00', '0.00', '0.00', 0, 0, 1, '2.00', '2.00', 0, 10, '0.00', '0.00', '0.00', 0, 10001, 10043, 10005, 1662603181);
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_refund` (
  `order_refund_id` int(11) unsigned NOT NULL COMMENT '售后单id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '拼团订单id',
  `order_goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单商品id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_refund_address` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_refund_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '售后单id',
  `name` varchar(30) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `phone` varchar(20) NOT NULL DEFAULT '' COMMENT '联系电话',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_order_refund_image` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_refund_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '售后单id',
  `image_id` int(11) NOT NULL DEFAULT '0' COMMENT '图片id(关联文件记录表)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
CREATE TABLE IF NOT EXISTS `yoshop_sharing_setting` (
  `key` varchar(30) NOT NULL DEFAULT '' COMMENT '设置项标示',
  `describe` varchar(255) NOT NULL DEFAULT '' COMMENT '设置项描述',
  `values` mediumtext NOT NULL COMMENT '设置内容(json格式)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
--
-- 表的结构 `yoshop_sharp_active`
--

CREATE TABLE IF NOT EXISTS `yoshop_sharp_active` (
  `active_id` int(11) unsigned NOT NULL COMMENT '活动会场ID',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='整点秒杀-活动会场表';

--
-- 转存表中的数据 `yoshop_sharp_active`
--

INSERT INTO `yoshop_sharp_active` (`active_id`, `active_date`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 1644940800, 1, 0, 10001, 1645004508, 1645004508),
(10002, 1645027200, 1, 0, 10001, 1645088339, 1645088339),
(10003, 1645113600, 1, 0, 10001, 1645166728, 1645166728),
(10004, 1645200000, 1, 0, 10001, 1645166750, 1645166750),
(10005, 1662566400, 1, 0, 10005, 1662603869, 1662603869);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharp_active_goods`
--

CREATE TABLE IF NOT EXISTS `yoshop_sharp_active_goods` (
  `id` int(11) unsigned NOT NULL COMMENT '主键ID',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10095 DEFAULT CHARSET=utf8 COMMENT='整点秒杀-活动会场与商品关联表';

--
-- 转存表中的数据 `yoshop_sharp_active_goods`
--

INSERT INTO `yoshop_sharp_active_goods` (`id`, `active_id`, `active_time_id`, `sharp_goods_id`, `sales_actual`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 10001, 10001, 0, 10001, 1645004508, 1645004508),
(10002, 10001, 10002, 10001, 0, 10001, 1645004508, 1645004508),
(10003, 10001, 10003, 10001, 0, 10001, 1645004508, 1645004508),
(10004, 10002, 10004, 10001, 0, 10001, 1645088339, 1645088339),
(10005, 10002, 10005, 10001, 0, 10001, 1645088339, 1645088339),
(10006, 10002, 10006, 10001, 0, 10001, 1645088339, 1645088339),
(10007, 10002, 10007, 10001, 0, 10001, 1645088339, 1645088339),
(10008, 10002, 10008, 10001, 0, 10001, 1645088339, 1645088339),
(10009, 10002, 10009, 10001, 0, 10001, 1645088339, 1645088339),
(10010, 10002, 10010, 10001, 0, 10001, 1645088339, 1645088339),
(10011, 10002, 10011, 10001, 0, 10001, 1645088339, 1645088339),
(10012, 10002, 10012, 10003, 0, 10001, 1645091951, 1645091951),
(10013, 10002, 10012, 10001, 0, 10001, 1645091951, 1645091951),
(10014, 10002, 10012, 10002, 0, 10001, 1645091951, 1645091951),
(10015, 10002, 10013, 10003, 0, 10001, 1645091951, 1645091951),
(10016, 10002, 10013, 10001, 0, 10001, 1645091951, 1645091951),
(10017, 10002, 10013, 10002, 0, 10001, 1645091951, 1645091951),
(10018, 10003, 10014, 10003, 0, 10001, 1645166728, 1645166728),
(10019, 10003, 10014, 10001, 0, 10001, 1645166728, 1645166728),
(10020, 10003, 10014, 10002, 0, 10001, 1645166728, 1645166728),
(10021, 10003, 10015, 10003, 0, 10001, 1645166728, 1645166728),
(10022, 10003, 10015, 10001, 0, 10001, 1645166728, 1645166728),
(10023, 10003, 10015, 10002, 0, 10001, 1645166728, 1645166728),
(10024, 10003, 10016, 10003, 0, 10001, 1645166728, 1645166728),
(10014, 10003, 0, 1, 10001, 1645166728, 1645166728),
(10015, 10003, 1, 1, 10001, 1645166728, 1645166728),
(10016, 10003, 2, 1, 10001, 1645166728, 1645166728),
(10017, 10003, 3, 1, 10001, 1645166728, 1645166728),
(10018, 10003, 4, 1, 10001, 1645166728, 1645166728),
(10019, 10003, 8, 1, 10001, 1645166728, 1645166728),
(10020, 10003, 10, 1, 10001, 1645166728, 1645166728),
(10021, 10003, 15, 1, 10001, 1645166728, 1645166728),
(10022, 10003, 17, 1, 10001, 1645166728, 1645166728),
(10023, 10003, 19, 1, 10001, 1645166728, 1645166728),
(10024, 10003, 20, 1, 10001, 1645166728, 1645166728),
(10025, 10003, 21, 1, 10001, 1645166728, 1645166728),
(10026, 10003, 22, 1, 10001, 1645166728, 1645166728),
(10027, 10003, 23, 1, 10001, 1645166728, 1645166728),
(10028, 10004, 0, 1, 10001, 1645166750, 1645166750),
(10029, 10004, 4, 1, 10001, 1645166750, 1645166750),
(10030, 10004, 6, 1, 10001, 1645166750, 1645166750),
(10031, 10004, 8, 1, 10001, 1645166750, 1645166750),
(10032, 10004, 10, 1, 10001, 1645166750, 1645166750),
(10033, 10004, 11, 1, 10001, 1645166750, 1645166750),
(10034, 10004, 13, 1, 10001, 1645166750, 1645166750),
(10035, 10004, 15, 1, 10001, 1645166750, 1645166750),
(10036, 10004, 16, 1, 10001, 1645166750, 1645166750),
(10037, 10004, 17, 1, 10001, 1645166750, 1645166750),
(10038, 10004, 21, 1, 10001, 1645166750, 1645166750),
(10039, 10005, 18, 1, 10005, 1662603869, 1662603869),
(10040, 10005, 23, 1, 10005, 1662603869, 1662603869);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharp_goods`
--

CREATE TABLE IF NOT EXISTS `yoshop_sharp_goods` (
  `sharp_goods_id` int(11) unsigned NOT NULL COMMENT '秒杀商品ID',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品ID',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='整点秒杀-商品表';

--
-- 转存表中的数据 `yoshop_sharp_goods`
--

INSERT INTO `yoshop_sharp_goods` (`sharp_goods_id`, `goods_id`, `deduct_stock_type`, `limit_num`, `seckill_stock`, `total_sales`, `sort`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, 10, 1, 1, 0, 100, 1, 0, 10001, 1645004162, 1645091707),
(10002, 10002, 10, 1, 1, 0, 101, 1, 0, 10001, 1645091420, 1645091621),
(10003, 10003, 10, 1, 1, 0, 100, 1, 0, 10001, 1645091789, 1645091789),
(10004, 10009, 10, 1, 99, 0, 100, 1, 0, 10005, 1662603519, 1663229611),
(10005, 10010, 10, 1, 1, 0, 100, 1, 0, 10005, 1663229639, 1663229639);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharp_goods_sku`
--

CREATE TABLE IF NOT EXISTS `yoshop_sharp_goods_sku` (
  `goods_sku_id` int(11) unsigned NOT NULL COMMENT '商品规格id',
  `spec_sku_id` varchar(255) NOT NULL DEFAULT '0' COMMENT '商品sku记录索引 (由规格id组成)',
  `sharp_goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '秒杀商品id',
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10013 DEFAULT CHARSET=utf8 COMMENT='整点秒杀-秒杀商品sku信息表';

--
-- 转存表中的数据 `yoshop_sharp_goods_sku`
--

INSERT INTO `yoshop_sharp_goods_sku` (`goods_sku_id`, `spec_sku_id`, `sharp_goods_id`, `seckill_price`, `seckill_stock`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10007, '0', 10002, '1.00', 1, 10001, 1645091621, 1645091621),
(10008, '0', 10001, '1.00', 1, 10001, 1645091707, 1645091707),
(10009, '0', 10003, '1.00', 1, 10001, 1645091789, 1645091789),
(10011, '0', 10004, '10.00', 99, 10005, 1663229611, 1663229611),
(10012, '0', 10005, '88.00', 1, 10005, 1663229639, 1663229639);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_sharp_setting`
--

CREATE TABLE IF NOT EXISTS `yoshop_sharp_setting` (
  `key` varchar(30) NOT NULL DEFAULT '' COMMENT '设置项标示',
  `describe` varchar(255) NOT NULL DEFAULT '' COMMENT '设置项描述',
  `values` mediumtext NOT NULL COMMENT '设置内容(json格式)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='商品规格组记录表';
...
CREATE TABLE IF NOT EXISTS `yoshop_spec_value` (
  ...
  `create_time` int(11) NOT NULL COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 COMMENT='商品规格值记录表';
...
(10001, '红色', 10001, 10001, 1655119360);
...
CREATE TABLE IF NOT EXISTS `yoshop_store_access` (
...
(10021, '添加商品', 'goods/add', 10019, 105, 1540628721, 1540628721),
(10022, '编辑商品', 'goods/edit', 10019, 110, 1540628721, 1540628721),
(10023, '复制商品', 'goods/copy', 10019, 115, 1540628721, 1540628721),
(10024, '删除商品', 'goods/delete', 10019, 120, 1540628721, 1540628721),
(10025, '商品上下架', 'goods/state', 10019, 125, 1540628721, 1540628721),
...
(10300, '拼团管理', 'apps.sharing', 10074, 105, 1544601161, 1544601161),
...
(10307, '商品列表', 'apps.sharing.goods/index', 10306, 105, 1544601378, 1544601378),
(10308, '添加商品', 'apps.sharing.goods/add', 10306, 110, 1544601378, 1544601378),
(10309, '编辑商品', 'apps.sharing.goods/edit', 10306, 115, 1544601378, 1544601378),
(10310, '复制商品', 'apps.sharing.goods/copy', 10306, 120, 1544601378, 1544601378),
(10311, '删除商品', 'apps.sharing.goods/delete', 10306, 125, 1544601378, 1544601378),
...
(10370, '满额包邮', 'market.basic/full_free', 10052, 125, 1551505016, 1551505016),
...
(10400, '好物圈', 'apps.wow', 10074, 120, 1557037952, 1557037952),
...
(10426, '砍价活动', 'apps.bargain', 10074, 110, 1559615418, 1559615441),
(10427, '砍价活动管理', 'apps.bargain.active', 10426, 100, 1559615566, 1559615566),
(10428, '砍价活动列表', 'apps.bargain.active/index', 10427, 100, 1559615601, 1559615601),
(10429, '新增砍价活动', 'apps.bargain.active/add', 10427, 105, 1559615601, 1559615601),
(10430, '编辑砍价活动', 'apps.bargain.active/edit', 10427, 110, 1559615601, 1559615601),
(10431, '删除砍价活动', 'apps.bargain.active/delete', 10427, 115, 1559615601, 1559615601),
(10432, '砍价记录', 'apps.bargain.task', 10426, 105, 1559615788, 1559615788),
(10433, '砍价记录列表', 'apps.bargain.task/index', 10432, 100, 1559615815, 1559615815),
(10434, '砍价助力榜', 'apps.bargain.task/help', 10432, 105, 1559615850, 1559615850),
(10435, '删除砍价记录', 'apps.bargain.task/delete', 10432, 110, 1559615878, 1559615878),
(10436, '砍价设置', 'apps.bargain.setting/index', 10426, 110, 1559615946, 1559615979),
(10437, '复制主商城商品', 'apps.sharing.goods/copy_master', 10306, 112, 1559615946, 1559615979),
(10438, '积分管理', 'market.points', 10052, 115, 1561080292, 1561080292),
(10439, '积分设置', 'market.points/setting', 10438, 100, 1561080384, 1561080384),
(10440, '积分明细', 'market.points/log', 10438, 105, 1561080384, 1561080384),
(10441, '消息推送', 'market.push', 10052, 120, 1561080292, 1561080292),
(10442, '发送消息', 'market.push/send', 10441, 100, 1561080384, 1561080384),
(10443, '活跃用户', 'market.push/user', 10441, 105, 1561080384, 1561080384),
(10444, '整点秒杀', 'apps.sharp', 10074, 115, 1564449650, 1564449650),
(10445, '秒杀商品', 'apps.sharp.goods', 10444, 100, 1564449650, 1564449650),
(10446, '商品列表', 'apps.sharp.goods/index', 10445, 100, 1564449650, 1564449650),
(10447, '新增商品', 'apps.sharp.goods/add', 10445, 105, 1564449650, 1564449650),
(10448, '编辑商品', 'apps.sharp.goods/edit', 10445, 110, 1564449650, 1564449650),
(10449, '删除商品', 'apps.sharp.goods/delete', 10445, 115, 1564449650, 1564449650),
(10450, '活动会场', 'apps.sharp.active', 10444, 105, 1564449650, 1564449650),
(10451, '会场列表', 'apps.sharp.active/index', 10450, 100, 1564449650, 1564449650),
(10452, '新增会场', 'apps.sharp.active/add', 10450, 105, 1564449650, 1564449650),
(10453, '修改活动状态', 'apps.sharp.active/state', 10450, 110, 1564449650, 1564449650),
(10454, '删除会场', 'apps.sharp.active/delete', 10450, 115, 1564449650, 1564449650),
(10455, '场次管理', 'apps.sharp.active_time', 10450, 120, 1564449650, 1564449650),
(10456, '场次列表', 'apps.sharp.active_time/index', 10455, 100, 1564449650, 1564449650),
(10457, '新增场次', 'apps.sharp.active_time/add', 10455, 105, 1564449650, 1564449650),
(10458, '编辑场次', 'apps.sharp.active_time/edit', 10455, 110, 1564449650, 1564449650),
(10459, '修改活动状态', 'apps.sharp.active_time/state', 10455, 115, 1564449650, 1564449650),
(10460, '删除场次', 'apps.sharp.active_time/delete', 10455, 120, 1564449650, 1564449650),
(10461, '基础设置', 'apps.sharp.setting/index', 10444, 125, 1564449650, 1564449650),
(10462, '小程序直播', 'apps.live', 10074, 125, 1585120375, 1585120375),
(10463, '直播间管理', 'apps.live.room/index', 10462, 100, 1585120404, 1585120404),
(10464, '同步刷新', 'apps.live.room/refresh', 10463, 100, 1585120404, 1585120404),
(10465, '设置置顶状态', 'apps.live.room/refresh', 10463, 100, 1585120404, 1585120404),
(11003, '数据统计', 'statistics.data/index', 0, 138, 1572507520, 1572507520);
...
CREATE TABLE IF NOT EXISTS `yoshop_store_role` (
...
(10001, '普通店员权限', 0, 100, 10005, 1663125658, 1663125658),
(10002, '店长权限', 0, 100, 10005, 1663125783, 1663125783),
(10003, '经理权限', 0, 100, 10005, 1663125858, 1663125858);
...
CREATE TABLE IF NOT EXISTS `yoshop_store_role_access` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `role_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '角色id',
  `access_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '权限id',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10535 DEFAULT CHARSET=utf8 COMMENT='商家用户角色权限关系表';
...
(10001, 10001, 10387, 10005, 1663125659),
(10002, 10001, 10388, 10005, 1663125659),
(10003, 10001, 10389, 10005, 1663125659),
(10004, 10001, 10050, 10005, 1663125659),
(10005, 10001, 10390, 10005, 1663125659),
(10006, 10001, 10391, 10005, 1663125659),
(10007, 10001, 10392, 10005, 1663125659),

...
CREATE TABLE IF NOT EXISTS `yoshop_store_shop_clerk` (
  ...
  `create_time` int(11) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 COMMENT='商家门店店员表';

--
-- 转存表中的数据 `yoshop_store_shop_clerk`
--

INSERT INTO `yoshop_store_shop_clerk` (`clerk_id`, `shop_id`, `user_id`, `real_name`, `mobile`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10003, 10043, 'w', '13888888888', 1, 0, 10005, 1662602064, 1662602064),
(10002, 10003, 10045, 'Silence', '17822227552', 1, 0, 10005, 1663565440, 1663565462);
...
CREATE TABLE IF NOT EXISTS `yoshop_store_shop_order` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单id',
  `order_type` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '订单类型(10商城订单 20拼团订单)',
...
CREATE TABLE IF NOT EXISTS `yoshop_store_user` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='商家用户记录表';
...
(10001, 'admin', '9c4cb25665cf08667c815420ab383cb5', '管理员', 1, 0, 10001, 1529926348, 1645002330),
(10002, 'test', '9c4cb25665cf08667c815420ab383cb5', '', 1, 0, 10002, 1644830175, 1644830175),
(10003, 'test1', 'dabd1de231e9899ca34c75e1a50aa8d0', '', 1, 0, 10003, 1644895639, 1644895639),
(10004, 'admin01', '9c4cb25665cf08667c815420ab383cb5', '', 1, 0, 10004, 1645002493, 1645002493),
(10005, 'admin0907', '9c4cb25665cf08667c815420ab383cb5', '', 1, 0, 10005, 1662540436, 1662540436);
...
CREATE TABLE IF NOT EXISTS `yoshop_store_user_role` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
...
CREATE TABLE IF NOT EXISTS `yoshop_upload_file` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `file_note` varchar(255) DEFAULT NULL COMMENT '备注'
) ENGINE=InnoDB AUTO_INCREMENT=10131 DEFAULT CHARSET=utf8 COMMENT='文件库记录表';

--
-- 转存表中的数据 `yoshop_upload_file`
--

INSERT INTO `yoshop_upload_file` (`file_id`, `storage`, `group_id`, `file_url`, `file_name`, `file_size`, `file_type`, `extension`, `is_user`, `is_recycle`, `is_delete`, `wxapp_id`, `create_time`, `file_note`) VALUES
(10001, 'local', 0, '', '20220216095407cc30b3788.png', 7700, 'image', 'png', 0, 1, 1, 10001, 1644976447, ''),
(10002, 'local', 0, '', '202202160957406e5155683.jpg', 440157, 'image', 'jpg', 0, 1, 1, 10001, 1644976660, NULL),
(10003, 'local', 10001, '', '20220216100221af0b85750.jpg', 39661, 'image', 'jpg', 0, 0, 0, 10001, 1644976941, NULL),
(10004, 'local', 10001, '', '20220216100221a83660439.jpg', 72553, 'image', 'jpg', 0, 0, 0, 10001, 1644976941, NULL),
(10005, 'local', 10002, '', '20220216100441214d59367.jpg', 100091, 'image', 'jpg', 0, 0, 0, 10001, 1644977081, NULL),
(10006, 'local', 10003, '', '20220216104354bec325196.png', 2192, 'image', 'png', 0, 0, 0, 10001, 1644979434, NULL),
(10007, 'local', 10003, '', '20220216104354292fb2622.png', 2678, 'image', 'png', 0, 0, 0, 10001, 1644979434, NULL),
(10008, 'local', 10003, '', '2022021610435497dfe2560.png', 2052, 'image', 'png', 0, 0, 0, 10001, 1644979434, NULL),
(10009, 'local', 10003, '', '202202161043543e3170207.png', 2650, 'image', 'png', 0, 0, 0, 10001, 1644979434, NULL),
(10010, 'local', 0, '', '202202161728102d4e15024.png', 7700, 'image', 'png', 0, 0, 0, 10001, 1645003690, NULL),
(10011, 'local', 0, '', '20220216172834522a95420.jpg', 28076, 'image', 'jpg', 0, 0, 0, 10001, 1645003714, NULL),
(10012, 'local', 0, '', '202202171513130cc929635.png', 187896, 'image', 'png', 0, 0, 0, 10001, 1645081993, NULL),
(10013, 'local', 0, '', '20220217154818ed95b6971.png', 228804, 'image', 'png', 0, 0, 0, 10001, 1645084098, NULL),
(10014, 'local', 0, '', '20220217161753689365899.png', 9166, 'image', 'png', 0, 0, 0, 10001, 1645085873, NULL),
(10015, 'local', 0, '', '202202171627158bf202102.png', 779, 'image', 'png', 0, 1, 0, 10001, 1645086435, NULL),
(10016, 'local', 0, '', '202202171627157f2688029.png', 1883, 'image', 'png', 0, 1, 0, 10001, 1645086435, NULL),
(10017, 'local', 0, '', '202202171627155f3f11147.png', 1789, 'image', 'png', 0, 1, 0, 10001, 1645086435, NULL),
(10018, 'local', 0, '', '202202171627150df605253.png', 2922, 'image', 'png', 0, 1, 0, 10001, 1645086435, NULL),
(10019, 'local', 0, '', '20220217162715166074558.png', 1200, 'image', 'png', 0, 1, 0, 10001, 1645086435, NULL),
(10020, 'local', 0, '', '20220217162823348144930.png', 690, 'image', 'png', 0, 1, 0, 10001, 1645086503, NULL),
(10021, 'local', 0, '', '20220217162910a7b0c4631.png', 1572, 'image', 'png', 0, 1, 0, 10001, 1645086550, NULL),
(10022, 'local', 0, '', '2022021716371056ace1594.png', 1188, 'image', 'png', 0, 1, 0, 10001, 1645087030, NULL),
(10023, 'local', 0, '', '20220217163710932112300.png', 2255, 'image', 'png', 0, 1, 0, 10001, 1645087030, NULL),
(10024, 'local', 0, '', '202202171637106473a0035.png', 2013, 'image', 'png', 0, 1, 0, 10001, 1645087030, NULL),
(10025, 'local', 0, '', '20220217163710d46648927.png', 3134, 'image', 'png', 0, 1, 0, 10001, 1645087030, NULL),
(10026, 'local', 0, '', '2022021716371090eef6631.png', 1601, 'image', 'png', 0, 1, 0, 10001, 1645087030, NULL),
(10027, 'local', 0, '', '20220217163825628fa1348.png', 3154, 'image', 'png', 0, 1, 0, 10001, 1645087105, NULL),
(10028, 'local', 0, '', '20220217164107907fe8643.png', 4863, 'image', 'png', 0, 0, 0, 10001, 1645087267, NULL),
(10029, 'local', 0, '', '202202171641070444e9906.png', 3446, 'image', 'png', 0, 0, 0, 10001, 1645087267, NULL),
(10030, 'local', 0, '', '202202171641071982a6717.png', 5563, 'image', 'png', 0, 0, 0, 10001, 1645087267, NULL),
(10031, 'local', 0, '', '20220217164107f0cef4655.png', 7801, 'image', 'png', 0, 0, 0, 10001, 1645087267, NULL),
(10032, 'local', 0, '', '20220217164107efb7c7109.png', 2526, 'image', 'png', 0, 0, 0, 10001, 1645087267, NULL),
(10033, 'local', 0, '', '20220217172125c884f5166.png', 162037, 'image', 'png', 0, 0, 0, 10001, 1645089685, NULL),
(10083, 'local', 10006, '', '20220914111554df9ee4076.jpg', 27844, 'image', 'jpg', 0, 1, 1, 10005, 1663125354, NULL),
(10084, 'local', 10006, '', '202209141115543dc815820.gif', 288228, 'image', 'gif', 0, 0, 0, 10005, 1663125354, NULL),
(10085, 'local', 10006, '', '2022091411155467a6e3074.gif', 455984, 'image', 'gif', 0, 0, 0, 10005, 1663125354, NULL),
(10086, 'local', 10006, '', '20220914111554296b29961.jpg', 89557, 'image', 'jpg', 0, 1, 1, 10005, 1663125354, NULL),
(10087, 'local', 10006, '', '202209141115548dfb48744.jpg', 38577, 'image', 'jpg', 0, 1, 1, 10005, 1663125354, NULL),
(10088, 'local', 10006, '', '20220914111554c02893465.jpg', 5468, 'image', 'jpg', 0, 1, 1, 10005, 1663125354, NULL),
(10089, 'local', 10006, '', '20220914111554460920422.jpg', 113276, 'image', 'jpg', 0, 1, 1, 10005, 1663125354, NULL),
(10090, 'local', 10006, '', '2022091411472027dbd1184.jpg', 46515, 'image', 'jpg', 0, 1, 1, 10005, 1663127240, NULL),
(10091, 'local', 10006, '', '2022091411472018a1c8393.png', 61006, 'image', 'png', 0, 1, 1, 10005, 1663127240, NULL),
(10092, 'local', 10006, '', '20220914114901bd4450066.jpg', 75337, 'image', 'jpg', 0, 1, 0, 10005, 1663127341, NULL),
(10093, 'local', 10006, '', '20220914114901157112437.jpg', 145595, 'image', 'jpg', 0, 0, 0, 10005, 1663127341, NULL),
(10094, 'local', 10006, '', '2022091411503685aee2158.jpg', 206453, 'image', 'jpg', 0, 0, 0, 10005, 1663127436, NULL),
(10095, 'local', 10006, '', '202209141325559f0a35835.jpg', 189931, 'image', 'jpg', 0, 1, 0, 10005, 1663133155, NULL),
(10096, 'local', 10006, '', '202209141411120540d4480.png', 14215, 'image', 'png', 0, 0, 0, 10005, 1663135872, NULL),
(10097, 'local', 10006, '', '202209141416289743b6689.png', 7381, 'image', 'png', 0, 0, 0, 10005, 1663136188, NULL),
(10098, 'local', 10006, '', '20220914141628c909d0340.png', 5497, 'image', 'png', 0, 0, 0, 10005, 1663136188, NULL),
(10099, 'local', 10006, '', '202209141416288e5ba6959.png', 6367, 'image', 'png', 0, 0, 0, 10005, 1663136188, NULL),
(10100, 'local', 10006, '', '20220914141629b23613182.png', 6817, 'image', 'png', 0, 0, 0, 10005, 1663136189, NULL),
(10101, 'local', 10006, '', '20220914142429748b35426.jpg', 122028, 'image', 'jpg', 0, 0, 0, 10005, 1663136669, NULL),
(10102, 'local', 10006, '', '20220914142435060019888.png', 43443, 'image', 'png', 0, 0, 0, 10005, 1663136675, NULL),
(10103, 'local', 10006, '', '20220914143541fe4ff7891.jpg', 265810, 'image', 'jpg', 0, 0, 0, 10005, 1663137341, NULL),
(10104, 'local', 10006, '', '20220914143541f07d13738.jpg', 238994, 'image', 'jpg', 0, 0, 0, 10005, 1663137341, NULL),
(10105, 'local', 10006, '', '20220919112650ee3d03456.png', 73210, 'image', 'png', 0, 1, 1, 10005, 1663558010, NULL),
(10106, 'local', 0, '', '2022091911270950a5c7837.png', 64935, 'image', 'png', 0, 1, 1, 10005, 1663558029, NULL),
(10107, 'local', 0, '', '2022091911272099ead2805.png', 76968, 'image', 'png', 0, 1, 1, 10005, 1663558040, NULL),
(10108, 'local', 10007, '', '202209191153354ec8d8496.png', 80638, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10109, 'local', 10007, '', '20220919115335f72177270.png', 61043, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10110, 'local', 10007, '', '20220919115335825728405.png', 51386, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10111, 'local', 10007, '', '202209191153359d1207439.png', 59164, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10112, 'local', 10007, '', '202209191153352809c0018.png', 32909, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10113, 'local', 10007, '', '202209191153358478f6415.png', 47838, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10114, 'local', 10007, '', '2022091911533599a955156.png', 60762, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10115, 'local', 10007, '', '2022091911533582bf88381.png', 48237, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10116, 'local', 10007, '', '20220919115335577e29900.png', 41022, 'image', 'png', 0, 0, 0, 10005, 1663559615, NULL),
(10117, 'local', 10007, '', '202209191153350360d4685.png', 35490, 'image', 'png', 0, 0, 0, 10005, 1663559615, ''),
(10118, 'local', 10007, '', '20220919115335cdf207341.png', 42335, 'image', 'png', 0, 0, 0, 10005, 1663559615, '4'),
(10119, 'local', 10007, '', '202209191153359a97b1215.png', 40116, 'image', 'png', 0, 0, 0, 10005, 1663559615, '3'),
(10120, 'local', 10007, '', '20220919115335112296157.png', 32997, 'image', 'png', 0, 0, 0, 10005, 1663559615, '2'),
(10121, 'local', 10007, '', '20220919115335f49b69954.png', 39931, 'image', 'png', 0, 0, 0, 10005, 1663559615, '1'),
(10122, '', 0, '', '', 0, '', '', 0, 0, 0, 0, 1663640275, '1'),
(10128, 'local', 0, '', '202209201459142c2679569.jpg', 131222, 'image', 'jpg', 0, 1, 0, 10001, 1663657154, NULL),
(10129, 'local', 0, '', '202209201524213466f4967.jpg', 131222, 'image', 'jpg', 0, 1, 0, 10001, 1663658661, NULL),
(10130, 'local', 0, '', '202209201653458da738113.jpg', 417344, 'image', 'jpg', 0, 1, 0, 10001, 1663664025, NULL);
...
CREATE TABLE IF NOT EXISTS `yoshop_upload_group` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10008 DEFAULT CHARSET=utf8 COMMENT='文件库分组记录表';

--
-- 转存表中的数据 `yoshop_upload_group`
--

INSERT INTO `yoshop_upload_group` (`group_id`, `group_type`, `group_name`, `sort`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 'image', 'banner', 100, 0, 10001, 1644977048, 1644977048),
(10002, 'image', '商品', 100, 0, 10001, 1644977062, 1644977062),
(10003, 'image', 'icon', 100, 0, 10001, 1644979416, 1663578952),
(10004, 'image', 'logo', 100, 0, 10001, 1646722952, 1646722952),
(10005, 'image', '迪士尼系列', 100, 0, 10005, 1663053376, 1663053376),
(10006, 'image', '装修元素', 100, 0, 10005, 1663122975, 1663122975),
(10007, 'image', '300*300', 100, 0, 10005, 1663559597, 1663559597);
...
CREATE TABLE IF NOT EXISTS `yoshop_user` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10047 DEFAULT CHARSET=utf8 COMMENT='用户记录表';

--
-- 转存表中的数据 `yoshop_user`
--

INSERT INTO `yoshop_user` (`user_id`, `open_id`, `nickName`, `avatarUrl`, `gender`, `country`, `province`, `city`, `address_id`, `balance`, `points`, `pay_money`, `expend_money`, `grade_id`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001,
(
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10010 DEFAULT CHARSET=utf8 COMMENT='用户收货地址表';
...
(10001, '啊啊啊', '13795233685', 1, 2, 3, '', '啊啊啊啊啊啊啊', 10001, 10001, 1644996539, 1644996539),
(10002, '袁欢', '15368707031', 2670, 2671, 2685, '', '云南经济管理学院（安宁校区）', 10012, 10001, 1646272771, 1646272771),
(10003, '钟先生', '15019998211', 1964, 2091, 0, '东莞市', '莞城街道大屏幕集团东莞尾音信息科技有限公司', 10002, 10001, 1650267029, 1650267029),
(10004, '刘菊红', '18727160701', 1709, 1822, 1823, '', '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10025, 10001, 1650600857, 1650600857),
(10005, '汪牡英', '18371538344', 1709, 1822, 1823, '', '湖北省仙桃市工业园区纺织大道八号仙桃职业学院', 10026, 10001, 1650600919, 1650600919),
(10006, '李玉', '17755674003', 351, 352, 353, '', '解放路15号解放路', 10027, 10001, 1651717610, 1651717644),
(10007, '先生', '13000000000', 1, 2, 3, '', '家', 10038, 10001, 1659340697, 1659340697),
(10008, '黎明', '13302227654', 1964, 1965, 1972, '', '区政府大院2号楼', 10041, 10001, 1661359317, 1661359317),
(10009, '测试', '13888888888', 1964, 1965, 1966, '', '测试', 10043, 10005, 1662555545, 1662555566);
...
CREATE TABLE IF NOT EXISTS `yoshop_user_balance_log` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序商城id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10017 DEFAULT CHARSET=utf8 COMMENT='用户余额变动明细表';

--
-- 转存表中的数据 `yoshop_user_balance_log`
--

INSERT INTO `yoshop_user_balance_log` (`log_id`, `user_id`, `scene`, `money`, `describe`, `remark`, `wxapp_id`, `create_time`) VALUES
(10001, 10001, 30, '100.00', '后台管理员 [admin] 操作', '', 10001, 1644999147),
(10002, 10001, 20, '-1.00', '用户消费：2022021656545410', '', 10001, 1644999224),
(10003, 10001, 40, '1.00', '订单退款：2022021656545410', '', 10001, 1645083266),
(10004, 10002, 30, '1000.00', '后台管理员 [admin] 操作', '', 10001, 1646724321),
(10005, 10002, 20, '-1.00', '用户消费：2022041897102515', '', 10001, 1650267035),
(10006, 10043, 20, '-13.00', '用户消费：2022090752555297', '', 10005, 1662555669),
(10007, 10043, 20, '-3.00', '用户消费：2022090810053549', '', 10005, 1662603181),
(10008, 10043, 20, '-10.00', '用户消费：2022090851989898', '', 10005, 1662604408),
(10009, 10043, 20, '-12.00', '用户消费：2022090849505710', '', 10005, 1662607425),
(10010, 10045, 30, '6000.00', '后台管理员 [admin0907] 操作', '', 10005, 1662620264),
(10011, 10043, 40, '3.00', '订单退款：2022090810053549', '', 10005, 1662705690),
(10012, 10046, 30, '1000.00', '后台管理员 [admin0907] 操作', '', 10005, 1663119961),
(10013, 10046, 30, '-100.00', '后台管理员 [admin0907] 操作', '', 10005, 1663557400),
(10014, 10046, 20, '-1.00', '用户消费：2022091910110250', '', 10005, 1663563471),
(10015, 10043, 20, '-2.00', '用户消费：2022091957535753', '', 10005, 1663569593),
(10016, 10043, 20, '-1.80', '用户消费：2022091952101102', '', 10005, 1663569870);
...
CREATE TABLE IF NOT EXISTS `yoshop_user_coupon` (
  ...
  `apply_range` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '适用范围(10全部商品 20指定商品)',
  `apply_range_config` varchar(255) NOT NULL,
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10011 DEFAULT CHARSET=utf8 COMMENT='用户优惠券记录表';

--
-- 转存表中的数据 `yoshop_user_coupon`
--

INSERT INTO `yoshop_user_coupon` (`user_coupon_id`, `coupon_id`, `name`, `color`, `coupon_type`, `reduce_price`, `discount`, `min_price`, `expire_type`, `expire_day`, `start_time`, `end_time`, `apply_range`, `apply_range_config`, `is_expire`, `is_use`, `user_id`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, 10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 1644996435, 1645255635, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 0, 1, 10001, 10001, 1644996435, 1644999224),
(10002, 10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 1645170495, 1645429695, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10003, 10001, 1645170495, 1645604620),
(10003, 10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 1645172955, 1645432155, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10004, 10001, 1645172955, 1645604620),
(10004, 10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 1646272713, 1646531913, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10012, 10001, 1646272713, 1646725068),
(10005, 10001, '测试优惠券', 10, 10, '10.00', 0, '10.00', 10, 3, 1651155123, 1651414323, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10024, 10001, 1651155123, 1651717043),
(10006, 10002, '满10减9', 20, 10, '9.00', 0, '10.00', 10, 30, 1651155125, 1653747125, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10024, 10001, 1651155125, 1653781169),
(10007, 10002, '满10减9', 20, 10, '9.00', 0, '10.00', 10, 30, 1659334536, 1661926536, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10038, 10001, 1659334536, 1661932958),
(10008, 10002, '满10减9', 20, 10, '9.00', 0, '10.00', 10, 30, 1661880377, 1664472377, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 0, 0, 10041, 10001, 1661880377, 1661880377),
(10009, 10003, '测试二', 10, 10, '20.00', 0, '123.00', 10, 3, 1662601945, 1662861145, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10043, 10005, 1662601945, 1663031458),
(10010, 10004, '优惠券测试三', 20, 10, '20.00', 0, '200.00', 10, 3, 1662604000, 1662863200, 10, '{"applyGoodsIds":[],"excludedGoodsIds":[]}', 1, 0, 10043, 10005, 1662604000, 1663031458);
...
CREATE TABLE IF NOT EXISTS `yoshop_user_grade` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='用户会员等级表';

--
-- 转存表中的数据 `yoshop_user_grade`
--

INSERT INTO `yoshop_user_grade` (`grade_id`, `name`, `weight`, `upgrade`, `equity`, `status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`) VALUES
(10001, '普通会员', 1, '{"expend_money":"100"}', '{"discount":"0"}', 1, 0, 10005, 1663120054, 1663147513),
(10002, '白银会员', 2, '{"expend_money":"500"}', '{"discount":"0"}', 1, 0, 10005, 1663120084, 1663147532),
(10003, '铂金会员', 3, '{"expend_money":"1000"}', '{"discount":"0"}', 1, 0, 10005, 1663120121, 1663147555),
(10004, '钻石会员', 4, '{"expend_money":"3000"}', '{"discount":"0"}', 1, 0, 10005, 1663147582, 1663147582),
(10005, '皇冠会员', 5, '{"expend_money":"5000"}', '{"discount":"0"}', 1, 0, 10005, 1663147602, 1663147602);
...
CREATE TABLE IF NOT EXISTS `yoshop_user_grade_log` (
  `log_id` int(11) unsigned NOT NULL COMMENT '主键id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10010 DEFAULT CHARSET=utf8 COMMENT='用户会员等级变更记录表';

--
-- 转存表中的数据 `yoshop_user_grade_log`
--

INSERT INTO `yoshop_user_grade_log` (`log_id`, `user_id`, `old_grade_id`, `new_grade_id`, `change_type`, `remark`, `wxapp_id`, `create_time`) VALUES
(10001, 10045, 0, 10002, 10, '', 10005, 1663120146),
(10002, 10044, 0, 10001, 10, '', 10005, 1663120157),
(10003, 10046, 0, 10001, 10, '', 10005, 1663120161),
(10004, 10043, 0, 10002, 10, '', 10005, 1663120167),
(10005, 10045, 10002, 10003, 10, '', 10005, 1663120172),
(10006, 10046, 10001, 10003, 10, '', 10005, 1663147626),
(10007, 10045, 10003, 10005, 10, '', 10005, 1663147636),
(10008, 10044, 10001, 10003, 10, '', 10005, 1663147647),
(10009, 10043, 10002, 10004, 10, '', 10005, 1663147659);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_user_points_log`
--

CREATE TABLE IF NOT EXISTS `yoshop_user_points_log` (
  `log_id` int(11) unsigned NOT NULL COMMENT '主键id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序商城id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间'
) ENGINE=InnoDB AUTO_INCREMENT=10005 DEFAULT CHARSET=utf8 COMMENT='用户积分变动明细表';

--
-- 转存表中的数据 `yoshop_user_points_log`
--

INSERT INTO `yoshop_user_points_log` (`log_id`, `user_id`, `value`, `describe`, `remark`, `wxapp_id`, `create_time`) VALUES
(10001, 10046, 1000, '后台管理员 [admin0907] 操作', '', 10005, 1663119974),
(10002, 10046, -100, '后台管理员 [admin0907] 操作', '', 10005, 1663557416),
(10003, 10043, 1000, '后台管理员 [admin0907] 操作', '', 10005, 1663569739),
(10004, 10043, -2, '用户消费：2022091952101102', '', 10005, 1663569860);
...
CREATE TABLE IF NOT EXISTS `yoshop_wow_order` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单id',
  `order_type` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '订单类型(10商城订单 20拼团订单)',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
CREATE TABLE IF NOT EXISTS `yoshop_wow_setting` (
  `key` varchar(30) NOT NULL DEFAULT '' COMMENT '设置项标示',
  `describe` varchar(255) NOT NULL DEFAULT '' COMMENT '设置项描述',
  `values` mediumtext NOT NULL COMMENT '设置内容(json格式)',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
--
-- 转存表中的数据 `yoshop_wow_setting`
--

INSERT INTO `yoshop_wow_setting` (`key`, `describe`, `values`, `wxapp_id`, `update_time`) VALUES
('basic', '基础设置', '{"is_shopping":"1","is_order":"1"}', 10001, 1661359005),
('basic', '基础设置', '{"is_shopping":"0","is_order":"1"}', 10005, 1663119579);
...
CREATE TABLE IF NOT EXISTS `yoshop_wow_shoping` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `goods_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `is_delete` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否删除',
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10006 DEFAULT CHARSET=utf8 COMMENT='微信小程序记录表';
...
(10001, 'wxea454987add92ae8', '99b60c93e179cd671fc0373dede462fc', '', '', '', '', 0, 0, 1529926348, 1644976585),
(10002, '', '', '', '', NULL, NULL, 0, 0, 1644830175, 1644830175),
(10003, '', '', '', '', NULL, NULL, 0, 0, 1644895639, 1644895639),
(10004, '', '', '', '', NULL, NULL, 0, 0, 1645002493, 1645002493),
(10005, 'wx993436d3db8f9889', '127447f8c2d021b7ccb5f39c35e336c8', '1631601094', '84pl123saA841321456klxus89a5z126', '-----BEGIN CERTIFICATE-----\r\\r\n-----END CERTIFICATE-----', '-----BEGIN PRIVATE KEY-----\r\\r\n-----END PRIVATE KEY-----', 0, 0, 1662540436, 1662629424);
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp_category` (
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
...
(10001, 20, '', 1536373988, 1645003282),
(10002, 11, '', 1644830175, 1644830175),
(10003, 11, '', 1644895639, 1644895639),
(10004, 11, '', 1645002493, 1645002493),
(10005, 20, '好物分享，一起看看吧！', 1662540436, 1663564620);
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp_formid` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp_help` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10007 DEFAULT CHARSET=utf8 COMMENT='微信小程序帮助';
...
(10002, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10002, 1644830175, 1644830175),
(10003, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10003, 1644895639, 1644895639),
(10004, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10004, 1645002493, 1645002493),
(10005, '关于小程序', '小程序本身无需下载，无需注册，不占用手机内存，可以跨平台使用，响应迅速，体验接近原生APP。', 100, 10005, 1662540436, 1662540436),
(10006, '联系我们', '使用过程中遇到任何商品或支付问题，请您咨询在线客服，或直接联系线下门店销售人员，我们将及时问您服务。', 100, 10005, 1663564754, 1663564754);

-- --------------------------------------------------------

--
-- 表的结构 `yoshop_wxapp_live_room`
--

CREATE TABLE IF NOT EXISTS `yoshop_wxapp_live_room` (
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp_page` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=10011 DEFAULT CHARSET=utf8 COMMENT='微信小程序diy页面表';
...
(10001, 10, '首页', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9996\\u9875","title":"SAAS\\u5546\\u57ce","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"},"id":"page"},"items":[{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"3"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#f1f1f2","lineStyle":"solid","lineHeight":"1","lineColor":"#f1f1f2","paddingTop":"5"}},{"name":"\\u641c\\u7d22\\u6846","type":"search","params":{"placeholder":"\\u8bf7\\u8f93\\u5165\\u4f60\\u8981\\u641c\\u7d22\\u7684\\u5546\\u54c1"},"style":{"textAlign":"left","searchStyle":"radius"},"id":"n50214144672381"},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#f1f1f2","lineStyle":"solid","lineHeight":"1","lineColor":"#f1f1f2","paddingTop":"0"}},{"name":"\\u56fe\\u7247\\u8f6e\\u64ad","type":"banner","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202202171513130cc929635.png","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220217154818ed95b6971.png","linkUrl":""}]},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"2"}},{"name":"\\u516c\\u544a\\u7ec4","type":"notice","params":{"text":"\\u6b22\\u8fce\\u6765\\u5230SAAS\\u5546\\u57ce\\uff0c\\u65b0\\u6625\\u4f18\\u60e0\\u6d3b\\u52a8\\u6d3b\\u52a8\\u65f6\\u95f42021\\u5e741\\u670820\\u65e5\\u81f32022\\u5e742\\u670820\\u65e5\\u3002","icon":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220217161753689365899.png"},"style":{"paddingTop":"4","background":"#ffffff","textColor":"#000000"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"2"}},{"name":"\\u8f85\\u52a9\\u7a7a\\u767d","type":"blank","style":{"height":"10","background":"#f5f5f5"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"2"}},{"name":"\\u5bfc\\u822a\\u7ec4","type":"navBar","style":{"background":"#ffffff","rowsNum":"5"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202202171641070444e9906.png","imgName":"icon-1.png","linkUrl":"","text":"\\u9999\\u6c34\\u5f69\\u5986","color":"#131319"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220217164107f0cef4655.png","imgName":"icon-2.jpg","linkUrl":"","text":"\\u517b\\u80a4\\u5957\\u76d2","color":"#131319"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202202171641071982a6717.png","imgName":"icon-3.jpg","linkUrl":"","text":"\\u56fd\\u6f6e\\u7f8e\\u5986","color":"#131319"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220217164107907fe8643.png","imgName":"icon-4.jpg","linkUrl":"","text":"\\u72ec\\u7279\\u7f8e\\u5986","color":"#131319"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220217164107efb7c7109.png","imgName":"icon-1.png","linkUrl":"","text":"\\u65b0\\u54c1\\u5c1d\\u9c9c","color":"#131319"}]},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"2"}},{"name":"\\u8f85\\u52a9\\u7a7a\\u767d","type":"blank","style":{"height":"10","background":"#f5f5f5"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"5"}},{"name":"\\u79d2\\u6740\\u5546\\u54c1\\u7ec4","type":"sharpGoods","params":{"showNum":"3"},"style":{"background":"#ffffff","column":"3","show":{"goodsName":false,"seckillPrice":true,"originalPrice":true}},"data":[{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"}]},{"name":"\\u89c6\\u9891\\u7ec4","type":"video","params":{"videoUrl":"https:\\/\\/dss0.bdstatic.com\\/-0U0bnSm1A5BphGlnYG\\/cae-legoup-video-target\\/b2d52a55-0d08-48b0-8346-50deaead9f27.mp4","poster":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/video_poster.png","autoplay":"1"},"style":{"paddingTop":"0","height":"216"}},{"name":"\\u8f85\\u52a9\\u7a7a\\u767d","type":"blank","style":{"height":"6","background":"#ffffff"}},{"name":"\\u8f85\\u52a9\\u7a7a\\u767d","type":"blank","style":{"height":"10","background":"#f5f5f5"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"6"}},{"name":"\\u5bcc\\u6587\\u672c","type":"richText","params":{"content":"<p style=\\"text-align: center;\\"><span style=\\"font-size:18px\\"><strong>-&nbsp;<span style=\\"font-size: large; text-align: center; white-space: normal;\\">\\u66f4\\u591a\\u63a8\\u8350&nbsp;<\\/span>-<\\/strong><\\/span><\\/p>"},"style":{"paddingTop":"0","paddingLeft":"0","background":"#ffffff"}},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#ffffff","paddingTop":"6"}},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]}]}', 10001, 0, 1536197290, 1646730959),
(10002, 10, '小程序首页', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u6807\\u9898","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"type":"search","name":"\\u641c\\u7d22\\u6846","params":{"placeholder":"\\u641c\\u7d22\\u5546\\u54c1"},"style":{"textAlign":"center","searchStyle":"radius"}},{"type":"banner","name":"\\u56fe\\u7247\\u8f6e\\u64ad","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]}]}', 10002, 0, 1644830175, 1644830175),
(10003, 10, '小程序首页', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u6807\\u9898","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"type":"search","name":"\\u641c\\u7d22\\u6846","params":{"placeholder":"\\u641c\\u7d22\\u5546\\u54c1"},"style":{"textAlign":"center","searchStyle":"radius"}},{"type":"banner","name":"\\u56fe\\u7247\\u8f6e\\u64ad","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]}]}', 10003, 0, 1644895639, 1644895639),
(10004, 10, '小程序首页', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u6807\\u9898","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"type":"search","name":"\\u641c\\u7d22\\u6846","params":{"placeholder":"\\u641c\\u7d22\\u5546\\u54c1"},"style":{"textAlign":"center","searchStyle":"radius"}},{"type":"banner","name":"\\u56fe\\u7247\\u8f6e\\u64ad","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"http:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]}]}', 10004, 0, 1645002493, 1645002493),
(10005, 20, '页面名称', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u540d\\u79f0","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u56fe\\u7247\\u8f6e\\u64ad","type":"banner","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]}]}', 10001, 0, 1648014164, 1648014164),
(10006, 20, '页面名称', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u540d\\u79f0","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"name":"\\u56fe\\u7247\\u8f6e\\u64ad","type":"banner","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]},{"name":"\\u5355\\u56fe\\u7ec4","type":"imageSingle","style":{"paddingTop":0,"paddingLeft":0,"background":"#ffffff"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","imgName":"image-1.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","imgName":"banner-2.jpg","linkUrl":""}]},{"name":"\\u56fe\\u7247\\u6a71\\u7a97","type":"window","style":{"paddingTop":"17","paddingLeft":"12","background":"#ffffff","layout":"3"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/01.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/02.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/03.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/04.jpg","linkUrl":""}],"dataNum":4}]}', 10001, 0, 1648014359, 1648014359),
(10007, 20, '页面名称', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u540d\\u79f0","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"name":"\\u5bfc\\u822a\\u7ec4","type":"navBar","style":{"background":"#ffffff","rowsNum":"4"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png","imgName":"icon-1.png","linkUrl":"","text":"\\u6309\\u94ae\\u6587\\u5b571","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png","imgName":"icon-2.jpg","linkUrl":"","text":"\\u6309\\u94ae\\u6587\\u5b572","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png","imgName":"icon-3.jpg","linkUrl":"","text":"\\u6309\\u94ae\\u6587\\u5b573","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/navbar\\/01.png","imgName":"icon-4.jpg","linkUrl":"","text":"\\u6309\\u94ae\\u6587\\u5b574","color":"#666666"}]}]}', 10001, 0, 1648439690, 1648439690),
(10008, 20, '页面名称', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u9875\\u9762\\u540d\\u79f0","title":"\\u9875\\u9762\\u6807\\u9898","share_title":"\\u5206\\u4eab\\u6807\\u9898"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"name":"\\u56fe\\u7247\\u8f6e\\u64ad","type":"banner","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/banner\\/01.png","linkUrl":""}]},{"name":"\\u641c\\u7d22\\u6846","type":"search","params":{"placeholder":"\\u8bf7\\u8f93\\u5165\\u5173\\u952e\\u5b57\\u8fdb\\u884c\\u641c\\u7d22"},"style":{"textAlign":"left","searchStyle":"square"}},{"name":"\\u516c\\u544a\\u7ec4","type":"notice","params":{"text":"\\u8fd9\\u91cc\\u662f\\u7b2c\\u4e00\\u6761\\u81ea\\u5b9a\\u4e49\\u516c\\u544a\\u7684\\u6807\\u9898","icon":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/notice.png"},"style":{"paddingTop":"4","background":"#ffffff","textColor":"#000000"}},{"name":"\\u79d2\\u6740\\u5546\\u54c1\\u7ec4","type":"sharpGoods","params":{"showNum":6},"style":{"background":"#ffffff","column":"3","show":{"goodsName":"1","seckillPrice":"1","originalPrice":"1"}},"data":[{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u5728\\u7ebf\\u5ba2\\u670d","type":"service","params":{"type":"chat","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/service.png","phone_num":""},"style":{"right":"1","bottom":"10","opacity":"100"}}]}', 10001, 0, 1649315920, 1649315920),
(10009, 10, '纽西卡汽车小镇', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u7ebd\\u897f\\u5361\\u6c7d\\u8f66\\u5c0f\\u9547","title":"\\u7ebd\\u897f\\u5361\\u6c7d\\u8f66\\u5c0f\\u9547","share_title":"\\u7ebd\\u897f\\u5361\\u5c0f\\u9547\\u5546\\u57ce"},"style":{"titleTextColor":"white","titleBackgroundColor":"#01b3a3"}},"items":[{"name":"\\u641c\\u7d22\\u6846","type":"search","params":{"placeholder":"\\u641c\\u7d22\\u5546\\u54c1"},"style":{"textAlign":"center","searchStyle":"round"}},{"name":"\\u5bfc\\u822a\\u7ec4","type":"navBar","style":{"background":"#ffffff","rowsNum":"4"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209141416289743b6689.png","imgName":"icon-1.png","linkUrl":"pages\\/category\\/list","text":"\\u4f1a\\u5458\\u4e13\\u533a","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220914141628c909d0340.png","imgName":"icon-2.jpg","linkUrl":"pages\\/category\\/list?category_id=10014","text":"\\u76ca\\u667a\\u73a9\\u5177","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209141416288e5ba6959.png","imgName":"icon-3.jpg","linkUrl":"pages\\/custom\\/index?page_id=10010","text":"\\u751f\\u6d3b\\u7528\\u54c1","color":"#666666"},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220914141629b23613182.png","imgName":"icon-4.jpg","linkUrl":"","text":"\\u79d1\\u5b66\\u5b9e\\u9a8c","color":"#666666"}]},{"name":"\\u56fe\\u7247\\u8f6e\\u64ad","type":"banner","style":{"btnColor":"#ffffff","btnShape":"round"},"params":{"interval":"2800"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220914143541fe4ff7891.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220914143541f07d13738.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/20220914114901157112437.jpg","linkUrl":""}]},{"name":"\\u516c\\u544a\\u7ec4","type":"notice","params":{"text":"\\u6b22\\u8fce\\u6765\\u5230\\u5c0f\\u9547\\u5546\\u57ce\\u4e28\\u6709\\u5fc3\\u610f\\u7684\\u73a9\\u5177\\uff0c\\u6709\\u65b0\\u610f\\u7684\\u7ae5\\u5e74\\uff01","icon":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/notice.png"},"style":{"paddingTop":"8","background":"#ffffff","textColor":"#000000"}},{"name":"\\u5934\\u6761\\u5feb\\u62a5","type":"special","params":{"source":"auto","auto":{"category":10001,"showNum":"3"}},"style":{"display":"1","image":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209141036228031e6180.png"},"defaultData":[{"article_title":"\\u5f20\\u5c0f\\u9f994\\u5c0f\\u65f6\\u6f14\\u8bb2\\uff1a\\u4f60\\u548c\\u9ad8\\u624b\\u4e4b\\u95f4\\uff0c\\u9694\\u7740\\u201c\\u7b80\\u5355\\u201d\\u4e8c\\u5b57"},{"article_title":"\\u5f20\\u5c0f\\u9f994\\u5c0f\\u65f6\\u6f14\\u8bb2\\uff1a\\u4f60\\u548c\\u9ad8\\u624b\\u4e4b\\u95f4\\uff0c\\u9694\\u7740\\u201c\\u7b80\\u5355\\u201d\\u4e8c\\u5b57"}],"data":[]},{"name":"\\u6587\\u7ae0\\u7ec4","type":"article","params":{"source":"auto","auto":{"category":10001,"showNum":"1"}},"style":[],"defaultData":[{"article_title":"\\u6b64\\u5904\\u663e\\u793a\\u6587\\u7ae0\\u6807\\u9898","show_type":10,"image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/article\\/01.png","views_num":"309"},{"article_title":"\\u6b64\\u5904\\u663e\\u793a\\u6587\\u7ae0\\u6807\\u9898","show_type":10,"image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/article\\/01.png","views_num":"309"}],"data":[]},{"name":"\\u4f18\\u60e0\\u5238\\u7ec4","type":"coupon","style":{"paddingTop":"8","background":"#ffffff"},"params":{"limit":"2"},"data":[{"color":"red","reduce_price":"10","min_price":"100.00"},{"color":"violet","reduce_price":"10","min_price":"100.00"}]},{"name":"\\u79d2\\u6740\\u5546\\u54c1\\u7ec4","type":"sharpGoods","params":{"showNum":"2"},"style":{"background":"#ffffff","column":"2","show":{"goodsName":"1","seckillPrice":"1","originalPrice":"1"}},"data":[{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u79d2\\u6740\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","seckill_price":"69.00","original_price":"139.00"}]},{"name":"\\u62fc\\u56e2\\u5546\\u54c1\\u7ec4","type":"sharingGoods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":"2"}},"style":{"background":"#f3f3f3","show":{"goodsName":"1","sellingPoint":"1","sharingPrice":"1","linePrice":"1"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","sharing_price":"99.00","line_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_price":"99.00","line_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","sharing_price":"99.00","line_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","sharing_price":"99.00","line_price":"139.00"}],"data":[{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","sharing_price":"99.00","line_price":"139.00","is_default":true},{"goods_name":"\\u6b64\\u5904\\u662f\\u62fc\\u56e2\\u5546\\u54c1","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u6027\\u4ef7\\u6bd4\\u8f83\\u9ad8 \\u4e0d\\u5bb9\\u9519\\u8fc7","sharing_price":"99.00","line_price":"139.00","is_default":true}]},{"name":"\\u780d\\u4ef7\\u5546\\u54c1\\u7ec4","type":"bargainGoods","params":{"source":"auto","auto":{"category":0,"goodsSort":"all","showNum":"2"}},"style":{"background":"#f3f3f3","show":{"goodsName":"1","peoples":"1","floorPrice":"1","originalPrice":"1"}},"demo":{"helps_count":2,"helps":[{"avatarUrl":"http:\\/\\/tva1.sinaimg.cn\\/large\\/0060lm7Tly1g4c7zrytvvj30dw0dwwes.jpg"},{"avatarUrl":"http:\\/\\/tva1.sinaimg.cn\\/large\\/0060lm7Tly1g4c7zs2u5ej30b40b4dfx.jpg"}]},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u662f\\u780d\\u4ef7\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","floor_price":"0.01","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u780d\\u4ef7\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","floor_price":"0.01","original_price":"139.00"}],"data":[{"goods_name":"\\u6b64\\u5904\\u662f\\u780d\\u4ef7\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","floor_price":"0.01","original_price":"139.00"},{"goods_name":"\\u6b64\\u5904\\u662f\\u780d\\u4ef7\\u5546\\u54c1","goods_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","floor_price":"0.01","original_price":"139.00"}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":10015,"goodsSort":"all","showNum":6}},"style":{"background":"#f3f3f3","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":10013,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u5546\\u54c1\\u7ec4","type":"goods","params":{"source":"auto","auto":{"category":10014,"goodsSort":"all","showNum":6}},"style":{"background":"#F6F6F6","display":"list","column":"2","show":{"goodsName":"1","goodsPrice":"1","linePrice":"1","sellingPoint":"0","goodsSales":"0"}},"defaultData":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100"}],"data":[{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true},{"goods_name":"\\u6b64\\u5904\\u663e\\u793a\\u5546\\u54c1\\u540d\\u79f0","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/goods\\/01.png","goods_price":"99.00","line_price":"139.00","selling_point":"\\u6b64\\u6b3e\\u5546\\u54c1\\u7f8e\\u89c2\\u5927\\u65b9 \\u4e0d\\u5bb9\\u9519\\u8fc7","goods_sales":"100","is_default":true}]},{"name":"\\u7ebf\\u4e0b\\u95e8\\u5e97","type":"shop","params":{"source":"choice","auto":{"showNum":"2"}},"style":[],"defaultData":[{"shop_name":"\\u6b64\\u5904\\u663e\\u793a\\u95e8\\u5e97\\u540d\\u79f0","logo_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/circular.png","phone":"010-6666666","region":{"province":"xx\\u7701","city":"xx\\u5e02","region":"xx\\u533a"},"address":"xx\\u8857\\u9053"},{"shop_name":"\\u6b64\\u5904\\u663e\\u793a\\u95e8\\u5e97\\u540d\\u79f0","logo_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/circular.png","phone":"010-6666666","region":{"province":"xx\\u7701","city":"xx\\u5e02","region":"xx\\u533a"},"address":"xx\\u8857\\u9053"}],"data":[{"shop_name":"\\u6b64\\u5904\\u663e\\u793a\\u95e8\\u5e97\\u540d\\u79f0","logo_image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/circular.png","phone":"010-6666666","region":{"province":"xx\\u7701","city":"xx\\u5e02","region":"xx\\u533a"},"address":"xx\\u8857\\u9053"},{"shop_id":"10003","shop_name":"\\u95e8\\u5e97\\u6d4b\\u8bd5","logo_image":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209071710526d8dc6338.jpg","phone":"123456789","region":{"province":"\\u5e7f\\u4e1c\\u7701","city":"\\u5e7f\\u5dde\\u5e02","region":"\\u8354\\u6e7e\\u533a"},"address":"\\u6d4b\\u8bd5"}]},{"name":"\\u5728\\u7ebf\\u5ba2\\u670d","type":"service","params":{"type":"chat","image":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/service.png","phone_num":""},"style":{"right":"1","bottom":"7","opacity":"93"}},{"name":"\\u5173\\u6ce8\\u516c\\u4f17\\u53f7","type":"officialAccount","params":[],"style":[]},{"name":"\\u8f85\\u52a9\\u7ebf","type":"guide","style":{"background":"#ffffff","lineStyle":"solid","lineHeight":"1","lineColor":"#000000","paddingTop":10}},{"name":"\\u641c\\u7d22\\u6846","type":"search","params":{"placeholder":"\\u8bf7\\u8f93\\u5165\\u5173\\u952e\\u5b57\\u8fdb\\u884c\\u641c\\u7d22"},"style":{"textAlign":"left","searchStyle":"square"}},{"name":"\\u5728\\u7ebf\\u5ba2\\u670d","type":"service","params":{"type":"chat","image":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209141411120540d4480.png","phone_num":""},"style":{"right":"3","bottom":"8","opacity":"100"}}]}', 10005, 0, 1662540436, 1663565055),
(10010, 20, '测试页面一', '{"page":{"type":"page","name":"\\u9875\\u9762\\u8bbe\\u7f6e","params":{"name":"\\u6d4b\\u8bd5\\u9875\\u9762\\u4e00","title":"\\u6d4b\\u8bd5\\u9875\\u9762\\u4e00","share_title":"\\u5206\\u4eab\\u6d4b\\u8bd5\\u9875\\u9762\\u4e00"},"style":{"titleTextColor":"black","titleBackgroundColor":"#ffffff"}},"items":[{"name":"\\u641c\\u7d22\\u6846","type":"search","params":{"placeholder":"\\u8bf7\\u8f93\\u5165\\u5173\\u952e\\u5b57\\u8fdb\\u884c\\u641c\\u7d22"},"style":{"textAlign":"left","searchStyle":"square"}},{"name":"\\u56fe\\u7247\\u6a71\\u7a97","type":"window","style":{"paddingTop":"0","paddingLeft":"0","background":"#ffffff","layout":"-1"},"data":[{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/uploads\\/202209071710526d8dc6338.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/02.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/03.jpg","linkUrl":""},{"imgUrl":"https:\\/\\/saas.weiyinstudio.com\\/assets\\/store\\/img\\/diy\\/window\\/04.jpg","linkUrl":""}],"dataNum":4}]}', 10005, 0, 1662606539, 1662606539);
...
CREATE TABLE IF NOT EXISTS `yoshop_wxapp_prepay_id` (
  `id` int(11) unsigned NOT NULL COMMENT '主键id',
  `user_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '用户id',
  `order_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '订单id',
  `order_type` tinyint(3) unsigned NOT NULL DEFAULT '10' COMMENT '订单类型(10商城订单 20拼团订单)',
...
--
-- Indexes for table `yoshop_admin_user`
--
...
--
-- Indexes for table `yoshop_article`
--
ALTER TABLE `yoshop_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indexes for table `yoshop_article_category`
--
ALTER TABLE `yoshop_article_category`
  ADD PRIMARY KEY (`category_id`);

--
-- Indexes for table `yoshop_bargain_active`
--
ALTER TABLE `yoshop_bargain_active`
  ADD PRIMARY KEY (`active_id`);

--
-- Indexes for table `yoshop_bargain_setting`
--
ALTER TABLE `yoshop_bargain_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_bargain_task`
--
ALTER TABLE `yoshop_bargain_task`
  ADD PRIMARY KEY (`task_id`);

--
-- Indexes for table `yoshop_bargain_task_help`
--
ALTER TABLE `yoshop_bargain_task_help`
  ADD PRIMARY KEY (`help_id`);

--
-- Indexes for table `yoshop_category`
--
ALTER TABLE `yoshop_category`
  ADD PRIMARY KEY (`category_id`);

--
-- Indexes for table `yoshop_comment`
--
ALTER TABLE `yoshop_comment`
  ADD PRIMARY KEY (`comment_id`);

--
-- Indexes for table `yoshop_comment_image`
--
ALTER TABLE `yoshop_comment_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_coupon`
--
ALTER TABLE `yoshop_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indexes for table `yoshop_coupon_goods`
--
ALTER TABLE `yoshop_coupon_goods`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_dealer_apply`
--
ALTER TABLE `yoshop_dealer_apply`
  ADD PRIMARY KEY (`apply_id`);

--
-- Indexes for table `yoshop_dealer_capital`
--
ALTER TABLE `yoshop_dealer_capital`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_dealer_order`
--
...
--
-- Indexes for table `yoshop_dealer_referee`
--
...
--
-- Indexes for table `yoshop_dealer_setting`
--
ALTER TABLE `yoshop_dealer_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_dealer_user`
--
ALTER TABLE `yoshop_dealer_user`
  ADD PRIMARY KEY (`user_id`);

--
-- Indexes for table `yoshop_dealer_withdraw`
--
ALTER TABLE `yoshop_dealer_withdraw`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_delivery`
--
ALTER TABLE `yoshop_delivery`
  ADD PRIMARY KEY (`delivery_id`);

--
-- Indexes for table `yoshop_delivery_rule`
--
ALTER TABLE `yoshop_delivery_rule`
  ADD PRIMARY KEY (`rule_id`);

--
-- Indexes for table `yoshop_express`
--
...
--
-- Indexes for table `yoshop_goods`
--
...
--
-- Indexes for table `yoshop_goods_image`
--
ALTER TABLE `yoshop_goods_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_goods_sku`
--
...
--
-- Indexes for table `yoshop_goods_spec_rel`
--
ALTER TABLE `yoshop_goods_spec_rel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_order`
--
...
--
-- Indexes for table `yoshop_return_address`
--
ALTER TABLE `yoshop_return_address`
  ADD PRIMARY KEY (`address_id`);

--
-- Indexes for table `yoshop_setting`
--
ALTER TABLE `yoshop_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_sharing_active`
--
ALTER TABLE `yoshop_sharing_active`
  ADD PRIMARY KEY (`active_id`);

--
-- Indexes for table `yoshop_sharing_active_users`
--
ALTER TABLE `yoshop_sharing_active_users`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_category`
--
ALTER TABLE `yoshop_sharing_category`
  ADD PRIMARY KEY (`category_id`);

--
-- Indexes for table `yoshop_sharing_comment`
--
ALTER TABLE `yoshop_sharing_comment`
  ADD PRIMARY KEY (`comment_id`);

--
-- Indexes for table `yoshop_sharing_comment_image`
--
ALTER TABLE `yoshop_sharing_comment_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_goods`
--
...
--
-- Indexes for table `yoshop_sharing_goods_image`
--
ALTER TABLE `yoshop_sharing_goods_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_goods_sku`
--
...
--
-- Indexes for table `yoshop_sharing_goods_spec_rel`
--
ALTER TABLE `yoshop_sharing_goods_spec_rel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_order`
--
...
--
-- Indexes for table `yoshop_sharing_order_address`
--
ALTER TABLE `yoshop_sharing_order_address`
  ADD PRIMARY KEY (`order_address_id`) USING BTREE;

--
-- Indexes for table `yoshop_sharing_order_extract`
--
ALTER TABLE `yoshop_sharing_order_extract`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `yoshop_sharing_order_goods`
--
ALTER TABLE `yoshop_sharing_order_goods`
  ADD PRIMARY KEY (`order_goods_id`) USING BTREE;

--
-- Indexes for table `yoshop_sharing_order_refund`
--
ALTER TABLE `yoshop_sharing_order_refund`
  ADD PRIMARY KEY (`order_refund_id`);

--
-- Indexes for table `yoshop_sharing_order_refund_address`
--
ALTER TABLE `yoshop_sharing_order_refund_address`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_order_refund_image`
--
ALTER TABLE `yoshop_sharing_order_refund_image`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharing_setting`
--
ALTER TABLE `yoshop_sharing_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_sharp_active`
--
ALTER TABLE `yoshop_sharp_active`
  ADD PRIMARY KEY (`active_id`);

--
-- Indexes for table `yoshop_sharp_active_goods`
--
ALTER TABLE `yoshop_sharp_active_goods`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_sharp_active_time`
--
ALTER TABLE `yoshop_sharp_active_time`
  ADD PRIMARY KEY (`active_time_id`);

--
-- Indexes for table `yoshop_sharp_goods`
--
ALTER TABLE `yoshop_sharp_goods`
  ADD PRIMARY KEY (`sharp_goods_id`);

--
-- Indexes for table `yoshop_sharp_goods_sku`
--
ALTER TABLE `yoshop_sharp_goods_sku`
  ADD PRIMARY KEY (`goods_sku_id`),
  ADD UNIQUE KEY `sku_idx` (`sharp_goods_id`,`spec_sku_id`);

--
-- Indexes for table `yoshop_sharp_setting`
--
ALTER TABLE `yoshop_sharp_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_spec`
--
ALTER TABLE `yoshop_spec`
  ADD PRIMARY KEY (`spec_id`);

--
-- Indexes for table `yoshop_spec_value`
--
ALTER TABLE `yoshop_spec_value`
  ADD PRIMARY KEY (`spec_value_id`);

--
-- Indexes for table `yoshop_store_access`
--
ALTER TABLE `yoshop_store_access`
  ADD PRIMARY KEY (`access_id`);

--
-- Indexes for table `yoshop_store_role`
--
ALTER TABLE `yoshop_store_role`
  ADD PRIMARY KEY (`role_id`);

--
-- Indexes for table `yoshop_store_role_access`
--
...
--
-- Indexes for table `yoshop_store_shop`
--
ALTER TABLE `yoshop_store_shop`
  ADD PRIMARY KEY (`shop_id`);

--
-- Indexes for table `yoshop_store_shop_clerk`
--
ALTER TABLE `yoshop_store_shop_clerk`
  ADD PRIMARY KEY (`clerk_id`);

--
-- Indexes for table `yoshop_store_shop_order`
--
ALTER TABLE `yoshop_store_shop_order`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_store_user`
--
...
--
-- Indexes for table `yoshop_store_user_role`
--
...
--
-- Indexes for table `yoshop_upload_file`
--
...
--
-- Indexes for table `yoshop_upload_group`
--
...
--
-- Indexes for table `yoshop_user_address`
--
ALTER TABLE `yoshop_user_address`
  ADD PRIMARY KEY (`address_id`);

--
-- Indexes for table `yoshop_user_balance_log`
--
ALTER TABLE `yoshop_user_balance_log`
  ADD PRIMARY KEY (`log_id`);

--
-- Indexes for table `yoshop_user_coupon`
--
ALTER TABLE `yoshop_user_coupon`
  ADD PRIMARY KEY (`user_coupon_id`);

--
-- Indexes for table `yoshop_user_grade`
--
...
--
-- Indexes for table `yoshop_user_grade_log`
--
ALTER TABLE `yoshop_user_grade_log`
  ADD PRIMARY KEY (`log_id`);

--
-- Indexes for table `yoshop_user_points_log`
--
ALTER TABLE `yoshop_user_points_log`
  ADD PRIMARY KEY (`log_id`);

--
-- Indexes for table `yoshop_wow_order`
--
ALTER TABLE `yoshop_wow_order`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_wow_setting`
--
ALTER TABLE `yoshop_wow_setting`
  ADD UNIQUE KEY `unique_key` (`key`,`wxapp_id`);

--
-- Indexes for table `yoshop_wow_shoping`
--
ALTER TABLE `yoshop_wow_shoping`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yoshop_wxapp`
--
ALTER TABLE `yoshop_wxapp`
  ADD PRIMARY KEY (`wxapp_id`);

--
-- Indexes for table `yoshop_wxapp_category`
--
ALTER TABLE `yoshop_wxapp_category`
  ADD PRIMARY KEY (`wxapp_id`);

--
-- Indexes for table `yoshop_wxapp_formid`
--
...
--
-- Indexes for table `yoshop_wxapp_help`
--
ALTER TABLE `yoshop_wxapp_help`
  ADD PRIMARY KEY (`help_id`);

--
-- Indexes for table `yoshop_wxapp_live_room`
--
...
--
-- Indexes for table `yoshop_wxapp_page`
--
...
--
-- Indexes for table `yoshop_wxapp_prepay_id`
--
...
--
-- AUTO_INCREMENT for table `yoshop_admin_user`
--
ALTER TABLE `yoshop_admin_user`
  MODIFY `admin_user_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_article`
--
ALTER TABLE `yoshop_article`
  MODIFY `article_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '文章id',AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `yoshop_article_category`
--
ALTER TABLE `yoshop_article_category`
  MODIFY `category_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品分类id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_bargain_active`
--
ALTER TABLE `yoshop_bargain_active`
  MODIFY `active_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '砍价活动id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_bargain_task`
--
ALTER TABLE `yoshop_bargain_task`
  MODIFY `task_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '砍价任务id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_bargain_task_help`
--
ALTER TABLE `yoshop_bargain_task_help`
  MODIFY `help_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_category`
--
ALTER TABLE `yoshop_category`
  MODIFY `category_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品分类id',AUTO_INCREMENT=10017;
--
-- AUTO_INCREMENT for table `yoshop_comment`
--
ALTER TABLE `yoshop_comment`
  MODIFY `comment_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '评价id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_comment_image`
--
ALTER TABLE `yoshop_comment_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_coupon`
--
ALTER TABLE `yoshop_coupon`
  MODIFY `coupon_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '优惠券id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_coupon_goods`
--
ALTER TABLE `yoshop_coupon_goods`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_dealer_apply`
--
ALTER TABLE `yoshop_dealer_apply`
  MODIFY `apply_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10004;
--
-- AUTO_INCREMENT for table `yoshop_dealer_capital`
--
ALTER TABLE `yoshop_dealer_capital`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_dealer_order`
--
ALTER TABLE `yoshop_dealer_order`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_dealer_referee`
--
ALTER TABLE `yoshop_dealer_referee`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_dealer_withdraw`
--
ALTER TABLE `yoshop_dealer_withdraw`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_delivery`
--
ALTER TABLE `yoshop_delivery`
  MODIFY `delivery_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '模板id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_delivery_rule`
--
ALTER TABLE `yoshop_delivery_rule`
  MODIFY `rule_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '规则id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_express`
--
ALTER TABLE `yoshop_express`
  MODIFY `express_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '物流公司id',AUTO_INCREMENT=10011;
--
-- AUTO_INCREMENT for table `yoshop_goods`
--
ALTER TABLE `yoshop_goods`
  MODIFY `goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品id',AUTO_INCREMENT=10012;
--
-- AUTO_INCREMENT for table `yoshop_goods_image`
--
ALTER TABLE `yoshop_goods_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10054;
--
-- AUTO_INCREMENT for table `yoshop_goods_sku`
--
ALTER TABLE `yoshop_goods_sku`
  MODIFY `goods_sku_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品规格id',AUTO_INCREMENT=10034;
--
-- AUTO_INCREMENT for table `yoshop_goods_spec_rel`
--
ALTER TABLE `yoshop_goods_spec_rel`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_order`
--
ALTER TABLE `yoshop_order`
  MODIFY `order_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单id',AUTO_INCREMENT=10024;
--
-- AUTO_INCREMENT for table `yoshop_order_address`
--
ALTER TABLE `yoshop_order_address`
  MODIFY `order_address_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址id',AUTO_INCREMENT=10021;
--
-- AUTO_INCREMENT for table `yoshop_order_extract`
--
ALTER TABLE `yoshop_order_extract`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10004;
--
-- AUTO_INCREMENT for table `yoshop_order_goods`
--
ALTER TABLE `yoshop_order_goods`
  MODIFY `order_goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10025;
--
-- AUTO_INCREMENT for table `yoshop_order_refund`
--
ALTER TABLE `yoshop_order_refund`
  MODIFY `order_refund_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '售后单id',AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `yoshop_order_refund_address`
--
ALTER TABLE `yoshop_order_refund_address`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `yoshop_order_refund_image`
--
ALTER TABLE `yoshop_order_refund_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_printer`
--
ALTER TABLE `yoshop_printer`
  MODIFY `printer_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '打印机id';
--
-- AUTO_INCREMENT for table `yoshop_recharge_order`
--
ALTER TABLE `yoshop_recharge_order`
  MODIFY `order_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单id',AUTO_INCREMENT=10025;
--
-- AUTO_INCREMENT for table `yoshop_recharge_order_plan`
--
ALTER TABLE `yoshop_recharge_order_plan`
  MODIFY `order_plan_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_recharge_plan`
--
ALTER TABLE `yoshop_recharge_plan`
  MODIFY `plan_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_region`
--
ALTER TABLE `yoshop_region`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',AUTO_INCREMENT=4019;
--
-- AUTO_INCREMENT for table `yoshop_return_address`
--
ALTER TABLE `yoshop_return_address`
  MODIFY `address_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '退货地址id',AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `yoshop_sharing_active`
--
ALTER TABLE `yoshop_sharing_active`
  MODIFY `active_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '拼单id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_active_users`
--
ALTER TABLE `yoshop_sharing_active_users`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_category`
--
ALTER TABLE `yoshop_sharing_category`
  MODIFY `category_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品分类id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_comment`
--
ALTER TABLE `yoshop_sharing_comment`
  MODIFY `comment_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '评价id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_comment_image`
--
ALTER TABLE `yoshop_sharing_comment_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_goods`
--
ALTER TABLE `yoshop_sharing_goods`
  MODIFY `goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '拼团商品id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_goods_image`
--
ALTER TABLE `yoshop_sharing_goods_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_goods_sku`
--
ALTER TABLE `yoshop_sharing_goods_sku`
  MODIFY `goods_sku_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品规格id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_goods_spec_rel`
--
ALTER TABLE `yoshop_sharing_goods_spec_rel`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_order`
--
ALTER TABLE `yoshop_sharing_order`
  MODIFY `order_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_address`
--
ALTER TABLE `yoshop_sharing_order_address`
  MODIFY `order_address_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '地址id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_extract`
--
ALTER TABLE `yoshop_sharing_order_extract`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_goods`
--
ALTER TABLE `yoshop_sharing_order_goods`
  MODIFY `order_goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_refund`
--
ALTER TABLE `yoshop_sharing_order_refund`
  MODIFY `order_refund_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '售后单id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_refund_address`
--
ALTER TABLE `yoshop_sharing_order_refund_address`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_sharing_order_refund_image`
--
ALTER TABLE `yoshop_sharing_order_refund_image`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_sharp_active`
--
ALTER TABLE `yoshop_sharp_active`
  MODIFY `active_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '活动会场ID',AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT for table `yoshop_sharp_active_goods`
--
ALTER TABLE `yoshop_sharp_active_goods`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',AUTO_INCREMENT=10095;
--
-- AUTO_INCREMENT for table `yoshop_sharp_active_time`
--
ALTER TABLE `yoshop_sharp_active_time`
  MODIFY `active_time_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '场次ID',AUTO_INCREMENT=10041;
--
-- AUTO_INCREMENT for table `yoshop_sharp_goods`
--
ALTER TABLE `yoshop_sharp_goods`
  MODIFY `sharp_goods_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '秒杀商品ID',AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT for table `yoshop_sharp_goods_sku`
--
ALTER TABLE `yoshop_sharp_goods_sku`
  MODIFY `goods_sku_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '商品规格id',AUTO_INCREMENT=10013;
--
-- AUTO_INCREMENT for table `yoshop_spec`
--
ALTER TABLE `yoshop_spec`
  MODIFY `spec_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '规格组id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_spec_value`
--
ALTER TABLE `yoshop_spec_value`
  MODIFY `spec_value_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '规格值id',AUTO_INCREMENT=10002;
--
-- AUTO_INCREMENT for table `yoshop_store_access`
--
ALTER TABLE `yoshop_store_access`
  MODIFY `access_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=11004;
--
-- AUTO_INCREMENT for table `yoshop_store_role`
--
ALTER TABLE `yoshop_store_role`
  MODIFY `role_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '角色id',AUTO_INCREMENT=10004;
--
-- AUTO_INCREMENT for table `yoshop_store_role_access`
--
ALTER TABLE `yoshop_store_role_access`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10535;
--
-- AUTO_INCREMENT for table `yoshop_store_shop`
--
ALTER TABLE `yoshop_store_shop`
  MODIFY `shop_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '门店id',AUTO_INCREMENT=10004;
--
-- AUTO_INCREMENT for table `yoshop_store_shop_clerk`
--
ALTER TABLE `yoshop_store_shop_clerk`
  MODIFY `clerk_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '店员id',AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `yoshop_store_shop_order`
--
ALTER TABLE `yoshop_store_shop_order`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_store_user`
--
ALTER TABLE `yoshop_store_user`
  MODIFY `store_user_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT for table `yoshop_store_user_role`
--
ALTER TABLE `yoshop_store_user_role`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_upload_file`
--
ALTER TABLE `yoshop_upload_file`
  MODIFY `file_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '文件id',AUTO_INCREMENT=10131;
--
-- AUTO_INCREMENT for table `yoshop_upload_group`
--
ALTER TABLE `yoshop_upload_group`
  MODIFY `group_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类id',AUTO_INCREMENT=10008;
--
-- AUTO_INCREMENT for table `yoshop_user`
--
ALTER TABLE `yoshop_user`
  MODIFY `user_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '用户id',AUTO_INCREMENT=10047;
--
-- AUTO_INCREMENT for table `yoshop_user_address`
--
ALTER TABLE `yoshop_user_address`
  MODIFY `address_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10010;
--
-- AUTO_INCREMENT for table `yoshop_user_balance_log`
--
ALTER TABLE `yoshop_user_balance_log`
  MODIFY `log_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10017;
--
-- AUTO_INCREMENT for table `yoshop_user_coupon`
--
ALTER TABLE `yoshop_user_coupon`
  MODIFY `user_coupon_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10011;
--
-- AUTO_INCREMENT for table `yoshop_user_grade`
--
ALTER TABLE `yoshop_user_grade`
  MODIFY `grade_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '等级ID',AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT for table `yoshop_user_grade_log`
--
ALTER TABLE `yoshop_user_grade_log`
  MODIFY `log_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10010;
--
-- AUTO_INCREMENT for table `yoshop_user_points_log`
--
ALTER TABLE `yoshop_user_points_log`
  MODIFY `log_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10005;
--
-- AUTO_INCREMENT for table `yoshop_wow_order`
--
ALTER TABLE `yoshop_wow_order`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_wow_shoping`
--
ALTER TABLE `yoshop_wow_shoping`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_wxapp`
--
ALTER TABLE `yoshop_wxapp`
  MODIFY `wxapp_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '小程序id',AUTO_INCREMENT=10006;
--
-- AUTO_INCREMENT for table `yoshop_wxapp_formid`
--
ALTER TABLE `yoshop_wxapp_formid`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_wxapp_help`
--
ALTER TABLE `yoshop_wxapp_help`
  MODIFY `help_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id',AUTO_INCREMENT=10007;
--
-- AUTO_INCREMENT for table `yoshop_wxapp_live_room`
--
ALTER TABLE `yoshop_wxapp_live_room`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
--
-- AUTO_INCREMENT for table `yoshop_wxapp_page`
--
ALTER TABLE `yoshop_wxapp_page`
  MODIFY `page_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '页面id',AUTO_INCREMENT=10011;
--
-- AUTO_INCREMENT for table `yoshop_wxapp_prepay_id`
--
ALTER TABLE `yoshop_wxapp_prepay_id`
  MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键id';
